...
//=========  (Fri May 29 09:44:25 2026) by ROOT version 6.32.13
   ...
   2500, 3200 };
   Double_t Graph0_fy1[35] = { 2.599102, 2.091783, 1.932878, 1.776062, 1.960294, 2.461797, 3.12422, 3.874115, 4.826618, 5.761793, 6.371889, 7.17373, 8.08674, 8.922657, 9.256818, 9.372034, 9.471134,
   9.244434, 9.392191, 7.595434, 7.62687, 6.796946, 6.33715, 6.0384, 5.904899, 5.292432, 5.218264, 5.007552, 4.934824, 4.808433, 4.528543, 5.075081, 4.222006,
   4.150805, 2.853008e-05 };
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph1_fy2[35] = { 4.008245, 3.96238, 2.641213, 0.08518696, 2.658486, 5.349922, 7.786751, 10.08065, 13.25815, 15.9807, 17.98724, 20.58567, 22.92411, 25.64422, 28.17922, 30.61811, 33.11712,
   34.44202, 36.93323, 38.80153, 41.10984, 44.43421, 48.45081, 52.80714, 57.80222, 63.43335, 70.64513, 77.50684, 83.58414, 89.44978, 96.60841, 104.2183, 109.9443,
   112.0193, 115.4899 };
   ...
   Graph_Graph12->SetMinimum(0.07666826);
   Graph_Graph12->SetMaximum(127.0304);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph2_fy3[35] = { 9.976787, 3.849125, 0.3846526, 0.6136715, 0.4052401, 1.055408, 2.093798, 1.189971, 1.270461, 1.372379, 1.87403, 1.436204, 1.921284, 1.688087, 2.529448, 1.858157, 2.125478,
   3.745675, 0.9997487, 2.173656, 2.092135, 2.39011, 1.279777, 3.557581, 1.079279, 1.760715, 1.140213, 1.41964, 0.5204976, 1.596308, 2.089489, 3.12109, 2.425402,
   3.719622, 10.70733 };
   ...
   Graph_Graph23->SetMinimum(0.3461874);
   Graph_Graph23->SetMaximum(11.7396);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph3_fy4[35] = { 0.3568411, 0.2109408, 0.5901933, 0.6054223, 0.5739331, 0.4342496, 0.9450793, 1.904023, 2.937007, 4.105937, 4.367971, 7.665825, 7.675207, 10.7386, 11.60339, 14.0311, 15.83476,
   14.99376, 20.24274, 20.66766, 21.44183, 24.07601, 28.40327, 29.74921, 34.05738, 35.4355, 42.20177, 48.00326, 50.36209, 49.19633, 52.08982, 62.83746, 70.05738,
   70.68638, 68.76537 };
   ...
   Graph_Graph34->SetMinimum(0.1898468);
   Graph_Graph34->SetMaximum(77.73392);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph4_fy5[35] = { 0.01487136, 0.009679794, 0.002264977, 0.00244379, 0.005912781, 0.009536743, 0.01374483, 0.02231598, 0.0271678, 0.03201962, 0.03168583, 0.03061295, 0.02638102, 0.02269745, 0.01769066, 0.01411438, 0.01020432,
   0.006246567, 0.008440018, 0.01306534, 0.01704693, 0.02285242, 0.02976656, 0.03739595, 0.0451684, 0.05571842, 0.06651878, 0.07683039, 0.08862019, 0.0987649, 0.1090884, 0.1157165, 0.1233339,
   0.133419, 0.1392126 };
   ...
   Graph_Graph45->SetMinimum(0.002038479);
   Graph_Graph45->SetMaximum(0.1529074);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph5_fy6[35] = { 2.175105, 2.001238, 1.594412, 0.2489686, 1.444197, 3.283131, 5.017406, 7.187634, 7.767302, 8.289444, 8.741629, 8.266062, 6.242418, 15.31004, 6.298357, 9.035462, 13.53327,
   16.17381, 16.08285, 19.68921, 20.03881, 24.30329, 29.60308, 39.30232, 48.49577, 36.7834, 43.51335, 49.09051, 62.80495, 85.45938, 96.52668, 99.7434, 100,
   100, 100 };
   ...
   Graph_Graph56->SetMinimum(0.2240717);
   Graph_Graph56->SetMaximum(109.9751);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph6_fy7[35] = { 1.43767, 0.7725835, 0.03693104, 0.344038, 0.6162286, 0.7769227, 0.8820891, 0.9082317, 0.9781003, 1.109529, 1.146352, 1.10327, 1.0234, 0.9933352, 1.00702, 1.078355, 1.204753,
   1.314306, 1.436079, 1.550722, 1.715565, 1.840293, 2.019918, 2.190948, 2.40165, 2.570069, 2.771389, 2.962017, 3.075349, 3.180897, 3.288376, 3.484476, 3.486109,
   3.250432, 3.276753 };
   ...
   Graph_Graph67->SetMinimum(0.03323793);
   Graph_Graph67->SetMaximum(3.831027);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph7_fy8[35] = { 0.1868606, 0.1815021, 0.1411557, 0.01816154, 0.1131654, 0.2588034, 0.4135847, 0.568974, 0.7405162, 0.9022713, 1.01757, 1.141453, 1.265836, 1.382828, 1.447773, 1.485348, 1.512146,
   1.465821, 1.482856, 1.421285, 1.38526, 1.347637, 1.318693, 1.258123, 1.224422, 1.16123, 1.124942, 1.075041, 0.9936154, 0.9276986, 0.9086132, 0.9557426, 0.9588599,
   0.8353174, 0.7859945 };
   ...
   Graph_Graph78->SetMinimum(0.01634538);
   Graph_Graph78->SetMaximum(1.661544);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph8_fy9[35] = { 11.37181, 6.29056, 3.711031, 2.021254, 3.725883, 6.887249, 10.08936, 13.20912, 16.46668, 19.44439, 21.57544, 24.63551, 26.36529, 33.05607, 32.61247, 36.20272, 40.3558,
   42.14289, 46.10818, 48.85915, 51.17356, 56.58461, 63.86068, 72.62083, 83.04302, 81.67956, 93.28781, 103.7233, 116.1989, 133.2723, 146.289, 157.5034, 164.4159,
   166.094, 167.9066 };
   ...
   Graph_Graph89->SetMinimum(1.819128);
   Graph_Graph89->SetMaximum(184.4951);
