...
//=========  (Fri May 29 09:44:30 2026) by ROOT version 6.32.13
   ...
   2500, 3200 };
   Double_t Graph0_fy1[35] = { 2.756902, 2.027379, 1.885756, 1.718495, 1.699937, 1.720676, 1.725736, 1.755439, 1.856396, 1.99833, 2.244003, 2.511894, 2.647679, 3.141069, 3.263286, 3.619443, 3.995589,
   4.199769, 4.58749, 4.062138, 4.516652, 4.01533, 4.111096, 4.121736, 4.044106, 3.731058, 3.901201, 3.938479, 4.130073, 4.355379, 4.420316, 5.367671, 4.823079,
   5.057119, 0.0008243832 };
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph1_fy2[35] = { 5.069643, 5.002201, 3.951091, 2.385348, 1.376975, 0.4435897, 0.6023407, 1.588428, 2.379775, 3.057837, 4.372048, 5.821264, 5.895853, 8.324528, 8.264791, 10.22621, 11.26022,
   11.29369, 13.51359, 14.79261, 16.39029, 17.38619, 21.46428, 23.81031, 25.20258, 28.48097, 32.32473, 34.62384, 35.58199, 36.62348, 38.38348, 42.01122, 44.12595,
   43.32039, 43.50706 };
   ...
   Graph_Graph12->SetMinimum(0.3992307);
   Graph_Graph12->SetMaximum(48.49419);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph2_fy3[35] = { 12.50495, 3.169036, 1.596868, 1.404732, 1.675367, 1.073396, 1.252854, 0.4718661, 1.32556, 2.496856, 1.841718, 4.092801, 2.03678, 8.948458, 6.220836, 7.092571, 12.22596,
   12.60589, 8.341825, 3.376961, 7.246619, 12.33875, 4.952967, 4.759395, 3.765798, 2.626932, 2.554524, 2.875829, 4.547262, 2.487153, 4.719907, 1.819068, 6.306511,
   7.440698, 3.642756 };
   ...
   Graph_Graph23->SetMinimum(0.4246795);
   Graph_Graph23->SetMaximum(13.81929);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph3_fy4[35] = { 0.377208, 0.2732635, 0.739038, 0.658828, 0.8207321, 1.599109, 2.606273, 3.744793, 3.683782, 2.879411, 0.7842302, 7.88517, 13.5335, 21.77061, 7.686311, 4.977322, 4.82471,
   4.226118, 7.755303, 1.139796, 5.882692, 6.004524, 7.457197, 12.64831, 12.55797, 20.27168, 20.20652, 24.17016, 25.96684, 15.74514, 22.63875, 34.64791, 37.08278,
   39.15263, 35.45409 };
   ...
   Graph_Graph34->SetMinimum(0.2459371);
   Graph_Graph34->SetMaximum(43.04057);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph4_fy5[35] = { 0.0120163, 0.01370907, 0.01181364, 0.004136562, 0.0120163, 0.01127124, 0.01186132, 0.01135468, 0.01019239, 0.009566545, 0.009691715, 0.01192093, 0.01360178, 0.0107646, 0.01906157, 0.0161767, 0.01823902,
   0.02382994, 0.01343489, 0.01581907, 0.01234412, 0.01429915, 0.016433, 0.01856089, 0.02577901, 0.03753304, 0.0518322, 0.05246401, 0.05347133, 0.05454421, 0.06113052, 0.06353855, 0.06965995,
   0.06673336, 0.06561875 };
   ...
   Graph_Graph45->SetMinimum(0.003722906);
   Graph_Graph45->SetMaximum(0.07621229);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph5_fy6[35] = { 2.945399, 2.797985, 2.484643, 1.657987, 0.9547234, 0.5270004, 0.03982782, 0.8339286, 1.240653, 1.345617, 2.756166, 3.276992, 3.537655, 6.204706, 5.057174, 5.265522, 8.681732,
   8.519464, 8.794266, 9.994012, 10.7951, 8.254224, 10.87896, 15.52199, 23.01106, 18.74217, 29.67474, 38.1891, 49.82791, 64.58659, 79.66661, 81.19653, 75.8779,
   60.42839, 72.66829 };
   ...
   Graph_Graph56->SetMinimum(0.03584504);
   Graph_Graph56->SetMaximum(89.3122);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph6_fy7[35] = { 1.482338, 0.7999957, 0.103277, 0.1330733, 0.2755284, 0.3226995, 0.3625035, 0.3850341, 0.3708482, 0.3489971, 0.3413916, 0.3130555, 0.2918243, 0.2331614, 0.1977921, 0.1542687, 0.1469851,
   0.01138449, 0.05922318, 0.1069725, 0.07573962, 0.09950399, 0.09887815, 0.2972603, 0.3809273, 0.5701959, 0.6965578, 0.8319676, 0.9163618, 1.055807, 1.165432, 1.411331, 1.535708,
   1.70595, 1.730722 };
   ...
   Graph_Graph67->SetMinimum(0.01024604);
   Graph_Graph67->SetMaximum(1.902656);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph7_fy8[35] = { 0.326407, 0.3260255, 0.2787471, 0.1766443, 0.1317918, 0.09607077, 0.03913045, 0.08382201, 0.1392007, 0.2172887, 0.3053725, 0.4000723, 0.4528582, 0.6218731, 0.626266, 0.7598162, 0.8874893,
   0.9280443, 1.068437, 1.176584, 1.304805, 1.351643, 1.572323, 1.713657, 1.811779, 1.880896, 1.987189, 1.965028, 1.823604, 1.6855, 1.586348, 1.672071, 1.645839,
   1.466417, 1.277798 };
   ...
   Graph_Graph78->SetMinimum(0.0352174);
   Graph_Graph78->SetMaximum(2.181995);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph8_fy9[35] = { 14.17029, 6.915557, 5.340909, 3.721328, 3.044869, 2.694077, 3.440631, 4.549906, 5.112056, 5.463404, 5.99697, 11.40704, 15.55252, 25.92562, 14.2387, 14.8688, 19.79119,
   19.88459, 20.29476, 18.68961, 22.2352, 24.01397, 26.0498, 31.7885, 36.82861, 39.97577, 48.57946, 57.18175, 66.82124, 76.09028, 91.53288, 97.95513, 95.6441,
   84.54099, 91.9154 };
   ...
   Graph_Graph89->SetMinimum(2.424669);
   Graph_Graph89->SetMaximum(107.4812);
