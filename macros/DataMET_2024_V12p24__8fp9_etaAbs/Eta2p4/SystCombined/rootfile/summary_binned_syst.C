...
//=========  (Wed Jun  3 17:22:15 2026) by ROOT version 6.32.13
   ...
   2500, 3200 };
   Double_t Graph0_fy1[35] = { 2.873556, 2.196308, 2.038164, 1.829616, 1.736977, 1.759735, 1.864208, 2.014684, 2.190448, 2.357761, 2.577461, 2.775951, 2.975683, 3.297274, 3.441386, 3.717111, 3.911773,
   4.101266, 4.586389, 3.949726, 4.521439, 3.999032, 4.252944, 4.147936, 4.149744, 3.792024, 3.624941, 3.238428, 3.009045, 2.733277, 2.489597, 2.898397, 2.272179,
   2.008632, 0.0005349525 };
   ...
   entry->SetMarkerSize(0.9);
   entry->SetTextFont(62);
   entry=leg->AddEntry("Graph","No fit","PE1");
   entry->SetLineColor(41);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(41);
   entry->SetMarkerStyle(48);
   entry->SetMarkerSize(0.9);
   entry->SetTextFont(62);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph1_fy2[35] = { 2.783209, 2.868104, 2.457464, 1.416719, 0.4725873, 0.1717925, 0.9249091, 1.453233, 1.964629, 2.516532, 3.301775, 3.989315, 4.006875, 6.130803, 5.467784, 6.706059, 7.018161,
   6.982791, 9.500254, 9.500206, 11.17724, 10.31495, 13.74421, 14.72628, 16.86084, 20.556, 23.97469, 27.83194, 29.90943, 32.01413, 34.28829, 37.64466, 40.319,
   41.65359, 42.76302 };
   ...
   Graph_Graph12->SetMinimum(0.1546133);
   Graph_Graph12->SetMaximum(47.02214);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph2_fy3[35] = { 3.889108, 0.9324908, 0.3292143, 0.8801758, 0.7013798, 0.4214823, 0.6997943, 0.2784729, 1.355171, 0.9965599, 0.4793167, 0.8811474, 3.346801, 8.294523, 5.747575, 4.086602, 3.907073,
   5.180192, 7.694256, 0.3552079, 2.663088, 6.176347, 2.860236, 1.614881, 0.2027631, 0.4892468, 1.597345, 2.417922, 0.002396107, 0.6250381, 0.9805381, 1.508355, 0.6103396,
   2.219099, 0.8626819 };
   ...
   Graph_Graph23->SetMinimum(0.002156496);
   Graph_Graph23->SetMaximum(9.123736);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph3_fy4[35] = { 0.002348423, 0.02580881, 0.3245831, 0.5023718, 0.5207777, 0.1173139, 0.2623916, 1.398754, 0.2257943, 0.989145, 0.848043, 0.7212639, 3.644675, 8.769965, 4.092991, 1.689625, 4.230928,
   4.458565, 5.6427, 0.3301024, 1.974976, 5.662596, 3.262722, 0.2196789, 1.760215, 3.569627, 5.444712, 8.203899, 13.76744, 20.04297, 24.15343, 24.67931, 23.97354,
   24.52444, 28.23183 };
   ...
   Graph_Graph34->SetMinimum(0.002113581);
   Graph_Graph34->SetMaximum(31.05478);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph4_fy5[35] = { 0.0185132, 0.007283688, 0.004518032, 0.002908707, 0.000667572, 0.002968311, 0.006347895, 0.008094311, 0.01134872, 0.01333952, 0.009971857, 0.01291633, 0.01013875, 0.009435415, 0.006103516, 0.01323819, 0.006866455,
   0.005984306, 0.004512072, 0.01313686, 0.002127886, 0.003010035, 0.01337528, 0.003397465, 0.008225441, 0.01381636, 0.03221035, 0.04364252, 0.05170107, 0.05792379, 0.06420612, 0.06835461, 0.07134676,
   0.07442236, 0.07263422 };
   ...
   Graph_Graph45->SetMinimum(0.0006008148);
   Graph_Graph45->SetMaximum(0.08179784);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph5_fy6[35] = { 1.156056, 0.9774446, 0.8936882, 0.4523516, 0.04408956, 0.2976894, 0.4124939, 0.7392347, 0.6256163, 0.07665157, 0.698781, 0.4885852, 0.5738914, 1.918042, 1.004308, 0.3052413, 3.701729,
   3.157735, 2.054363, 3.924143, 3.666383, 1.408356, 2.363974, 6.877661, 14.15998, 7.124525, 17.98702, 26.32294, 39.23268, 56.23916, 75.80483, 77.29228, 68.04928,
   43.35454, 57.78266 };
   ...
   Graph_Graph56->SetMinimum(0.0396806);
   Graph_Graph56->SetMaximum(85.0171);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph6_fy7[35] = { 1.612139, 0.9566545, 0.3177285, 0.008839369, 0.1915693, 0.3395557, 0.4289031, 0.5194187, 0.5555868, 0.6070137, 0.6519437, 0.7026076, 0.7245779, 0.8306861, 0.7371545, 0.8630157, 0.9866118,
   0.8360267, 0.9605885, 1.076651, 1.105797, 1.173484, 1.098561, 1.259518, 1.340866, 1.336002, 1.393151, 1.323926, 1.257896, 1.144588, 1.107812, 1.170039, 1.121104,
   0.8684158, 0.7318616 };
   ...
   Graph_Graph67->SetMinimum(0.007955432);
   Graph_Graph67->SetMaximum(1.772469);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph7_fy8[35] = { 0.06576777, 0.06695986, 0.06099939, 0.03511906, 0.01888275, 0.009691715, 0.001835823, 0.01698732, 0.02510548, 0.04355907, 0.06248355, 0.08884668, 0.105536, 0.1523137, 0.1570821, 0.2025485, 0.2346814,
   0.2550185, 0.3062189, 0.3571689, 0.3929198, 0.4281402, 0.5182683, 0.5766332, 0.6476462, 0.6936789, 0.7394731, 0.7312655, 0.6737232, 0.6193936, 0.5740166, 0.6192148, 0.6042957,
   0.5318403, 0.4535615 };
   ...
   Graph_Graph78->SetMinimum(0.001652241);
   Graph_Graph78->SetMaximum(0.8132368);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph8_fy9[35] = { 5.921897, 3.974307, 3.363086, 2.566635, 2.010614, 1.876595, 2.289856, 3.003584, 3.353525, 3.773582, 4.405823, 5.065335, 7.089434, 14.09122, 9.649028, 8.9007, 10.60443,
   11.09181, 14.40723, 11.0804, 13.08382, 14.00523, 15.26044, 16.90994, 22.52488, 22.42622, 30.75946, 39.41372, 51.32653, 67.81612, 86.6843, 89.51379, 82.69353,
   65.00836, 77.24014 };
   ...
   Graph_Graph89->SetMinimum(1.688935);
   Graph_Graph89->SetMaximum(98.27751);
