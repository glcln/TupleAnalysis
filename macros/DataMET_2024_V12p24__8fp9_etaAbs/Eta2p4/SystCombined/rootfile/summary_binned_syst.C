...
//=========  (Tue Jun  2 17:21:00 2026) by ROOT version 6.32.13
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph2_fy3[35] = { 12.85933, 2.380013, 0.7279754, 0.8801758, 1.238048, 0.4214823, 1.197654, 0.2784729, 1.493192, 1.64966, 0.759542, 3.097516, 3.346801, 8.294523, 5.747575, 4.892766, 15.23676,
   10.51601, 7.694256, 5.658042, 3.384429, 10.30026, 4.200184, 1.749319, 0.2027631, 1.499653, 2.18147, 2.417922, 0.3010631, 2.638686, 0.9805381, 3.854311, 0.9529471,
   2.219099, 7.91496 };
   ...
   Graph_Graph23->SetMinimum(0.1824868);
   Graph_Graph23->SetMaximum(16.74016);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph3_fy4[35] = { 0.9573996, 0.2430499, 0.9491742, 0.5023718, 0.8487582, 1.323593, 2.233672, 3.855228, 3.457952, 2.538002, 0.848043, 8.410335, 14.20192, 24.50088, 8.100867, 6.602526, 4.230928,
   4.458565, 9.020376, 1.020491, 7.654989, 5.662596, 10.01464, 15.67296, 18.12992, 27.94247, 29.41867, 35.39594, 38.50422, 28.57233, 39.32859, 56.55709, 61.18245,
   62.67853, 60.18145 };
   ...
   Graph_Graph34->SetMinimum(0.2187449);
   Graph_Graph34->SetMaximum(68.92208);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph4_fy5[35] = { 0.0185132, 0.007283688, 0.006783009, 0.006961823, 0.006222725, 0.002968311, 0.006347895, 0.008779764, 0.01367927, 0.01554489, 0.01651049, 0.01975894, 0.01757145, 0.01859665, 0.01693964, 0.01872182, 0.01828074,
   0.01308322, 0.01959205, 0.02090335, 0.01333356, 0.0131011, 0.02179742, 0.008302927, 0.008225441, 0.01381636, 0.03221035, 0.04364252, 0.05170107, 0.05792379, 0.06420612, 0.06835461, 0.07134676,
   ...
   Graph_Graph45->SetMinimum(0.00267148);
   Graph_Graph45->SetMaximum(0.08156776);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph7_fy8[35] = { 0.07693768, 0.08363724, 0.07129312, 0.03740788, 0.01888275, 0.009691715, 0.01322031, 0.02702475, 0.03558397, 0.04874468, 0.07090569, 0.09505749, 0.1103997, 0.1686811, 0.163579, 0.2071738, 0.2380252,
   0.2550185, 0.3111362, 0.3571689, 0.4056931, 0.4409194, 0.5447745, 0.6209731, 0.7174611, 0.7851601, 0.8539081, 0.8624792, 0.8237839, 0.7828832, 0.7485151, 0.7988811, 0.7875085,
   0.7185578, 0.6346941 };
   ...
   Graph_Graph78->SetMinimum(0.008722544);
   Graph_Graph78->SetMaximum(0.947758);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph8_fy9[35] = { 13.6464, 4.544333, 3.539616, 2.566675, 2.352152, 2.293413, 3.332974, 4.68276, 4.852464, 4.629445, 4.445192, 10.23185, 15.44902, 26.86911, 11.91543, 11.27838, 18.14798,
   14.37986, 16.0343, 12.47378, 15.17423, 16.25134, 18.22136, 23.0661, 28.8628, 35.6808, 42.24154, 52.33755, 62.67185, 70.85538, 92.07469, 103.03, 100.0378,
   86.91071, 94.0899 };
   ...
   Graph_Graph89->SetMinimum(2.064072);
   Graph_Graph89->SetMaximum(113.1037);
