...
//=========  (Wed Jul  8 12:47:13 2026) by ROOT version 6.32.13
   ...
   2500, 3200 };
   Double_t Graph0_fy1[35] = { 0, 0, 5.887624, 2.60886, 1.927078, 1.695911, 1.606882, 1.631437, 1.638558, 1.696353, 1.797737, 1.910293, 1.948818, 2.047606, 2.012312, 2.083147, 2.269847,
   2.16165, 2.354338, 2.136968, 2.347357, 2.155775, 2.445534, 2.614259, 2.86688, 2.92715, 3.431291, 4.39664, 6.090781, 8.045437, 11.01713, 15.43533, 12.89479,
   15.05316, 0.001079184 };
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph1_fy2[35] = { 100, 100, 23.55089, 2.578151, 3.164291, 2.860475, 1.817143, 0.7045567, 0.2730608, 0.8258343, 1.069641, 1.932466, 1.721287, 3.21101, 1.745725, 2.856445, 3.973746,
   1.282597, 2.99294, 4.073977, 4.916275, 2.439892, 4.185081, 4.331875, 4.914117, 4.286802, 4.952187, 6.966382, 4.901767, 7.117629, 10.82861, 15.13897, 14.44842,
   17.88572, 24.09785 };
   ...
   Graph_Graph12->SetMinimum(0.2457547);
   Graph_Graph12->SetMaximum(109.9727);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph2_fy3[35] = { 100, 100, 4.484141, 4.572535, 5.272698, 1.908994, 1.985502, 0.7405877, 1.126873, 2.110797, 1.909941, 1.844531, 11.73729, 10.67703, 10.99385, 0.5455554, 22.98149,
   16.90159, 8.242345, 22.10844, 3.123063, 18.87457, 8.059812, 11.68452, 8.94562, 11.34743, 7.91775, 11.03481, 13.92249, 6.157088, 19.50378, 10.08182, 12.17933,
   15.76883, 18.23862 };
   ...
   Graph_Graph23->SetMinimum(0.4909998);
   Graph_Graph23->SetMaximum(109.9454);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph3_fy4[35] = { 100, 100, 2.974999, 0.4516721, 1.510632, 1.056874, 1.781315, 2.539384, 1.996815, 5.117613, 3.519434, 13.19168, 21.51483, 30.8587, 12.48661, 5.099952, 5.604148,
   9.337467, 9.792829, 3.031492, 2.032685, 18.97907, 1.760179, 11.64862, 3.357017, 17.78923, 25.52525, 30.54224, 50.65925, 71.04082, 85.4973, 91.96392, 92.97591,
   93.26328, 94.23106 };
   ...
   Graph_Graph34->SetMinimum(0.4065049);
   Graph_Graph34->SetMaximum(109.9548);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph4_fy5[35] = { 100, 100, 0.04361868, 0.007098913, 0.007241964, 0.007301569, 0.004005432, 0.002545118, 0.005030632, 0.002336502, 0.0009775162, 0.007176399, 0.01393557, 0.01990795, 0.01426935, 0.0138998, 0.01810789,
   0.004768372, 0.008678436, 0.005412102, 0.01465082, 0.002658367, 0.02710819, 0.01417398, 0.015378, 0.04069209, 0.02884865, 0.02521276, 0.07704496, 0.113523, 0.2216935, 0.4134357, 0.5509675,
   0.9673059, 1.34424 };
   ...
   Graph_Graph45->SetMinimum(0.0008797646);
   Graph_Graph45->SetMaximum(109.9999);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph5_fy6[35] = { 100, 100, 0.6451786, 0.699538, 0.567317, 0.2743542, 0.05128384, 0.08852482, 0.1209021, 0.2099991, 0.2630949, 0.3000617, 0.286305, 0.4897475, 0.3366828, 0.4137278, 0.6322265,
   0.3770232, 0.5611777, 0.6507874, 0.7733703, 0.7053971, 0.9103656, 0.975728, 1.143944, 1.048887, 1.080215, 0.6554484, 0.5242944, 1.411855, 2.408278, 2.824426, 1.306212,
   1.090413, 2.960563 };
   ...
   Graph_Graph56->SetMinimum(0.04615545);
   Graph_Graph56->SetMaximum(109.9949);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph6_fy7[35] = { 100, 100, 0.1139581, 0.03041029, 0.0238657, 0.02816319, 0.03153682, 0.02735853, 0.02644062, 0.01059771, 0.01635551, 0.02807379, 0.02564192, 0.04162788, 0.02862215, 0.04333258, 0.05317926,
   0.04760027, 0.06946325, 0.07808208, 0.1068234, 0.08282661, 0.1166344, 0.1281142, 0.141561, 0.1310587, 0.1758695, 0.2344489, 0.3090978, 0.2824306, 0.220561, 0.2041519, 0.3255904,
   0.6609857, 0.9622455 };
   ...
   Graph_Graph67->SetMinimum(0.009537935);
   Graph_Graph67->SetMaximum(109.9989);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph7_fy8[35] = { 244.949, 244.949, 24.87364, 5.920762, 6.643207, 3.986952, 3.60597, 3.188028, 2.834059, 5.852286, 4.525458, 13.59769, 24.64743, 32.87862, 16.85205, 6.24333, 24.10189,
   19.47599, 13.36623, 22.794, 6.64642, 26.97331, 9.612358, 17.28544, 11.1799, 21.7551, 27.41761, 33.51032, 53.11965, 72.12616, 89.07704, 95.05069, 95.76014,
   97.44615, 99.01689 };
   ...
   Graph_Graph78->SetMinimum(2.550653);
   Graph_Graph78->SetMaximum(269.1605);
