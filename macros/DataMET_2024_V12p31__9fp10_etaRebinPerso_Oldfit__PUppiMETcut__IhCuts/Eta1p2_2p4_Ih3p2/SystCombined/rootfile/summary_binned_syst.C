...
//=========  (Wed Jul  8 12:46:55 2026) by ROOT version 6.32.13
   ...
   2500, 3200 };
   Double_t Graph0_fy1[35] = { 0, 6.61922, 2.301075, 1.549371, 1.292227, 1.221972, 1.190365, 1.197811, 1.232041, 1.278992, 1.358549, 1.38654, 1.451847, 1.542957, 1.54764, 1.649256, 1.769675,
   1.698596, 1.83088, 1.727518, 1.933724, 1.746822, 1.870615, 1.927192, 2.226266, 2.311178, 2.842868, 3.946048, 6.563263, 8.066203, 11.27913, 14.11465, 10.36471,
   10.66126, 0.0009505869 };
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph1_fy2[35] = { 100, 20.80547, 5.874562, 0.7277548, 2.499902, 1.929426, 0.9448469, 0.1373291, 0.3937483, 1.097107, 1.255727, 1.875567, 1.787519, 2.90451, 1.703584, 2.597165, 3.651083,
   1.333714, 2.862036, 4.02801, 4.827905, 2.786326, 4.311407, 4.376316, 5.49525, 4.932809, 6.058896, 10.46157, 13.29744, 17.52099, 17.20114, 23.16789, 30.52288,
   39.47606, 46.16612 };
   ...
   Graph_Graph12->SetMinimum(0.1235962);
   Graph_Graph12->SetMaximum(109.9863);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph2_fy3[35] = { 100, 3.666943, 2.070177, 2.100825, 2.811217, 1.421309, 2.100587, 0.8352399, 0.9061694, 2.732188, 2.829319, 2.67843, 8.42281, 10.31344, 12.89643, 4.101145, 24.69641,
   15.6131, 5.727732, 17.89459, 6.970429, 18.13238, 6.038279, 7.093835, 14.49221, 12.01544, 8.621907, 5.116189, 15.04678, 10.24767, 20.6291, 14.98522, 12.91381,
   12.38473, 10.26264 };
   ...
   Graph_Graph23->SetMinimum(0.7517159);
   Graph_Graph23->SetMaximum(109.9165);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph3_fy4[35] = { 100, 0.8172035, 0.9782255, 0.4861414, 0.8730769, 0.24845, 2.421325, 3.987026, 2.097344, 2.457952, 2.477521, 10.9741, 17.13672, 30.59761, 13.08013, 7.248306, 8.419847,
   17.51074, 13.95657, 3.468812, 3.821516, 14.55389, 3.545982, 8.062744, 10.94072, 20.61211, 28.37735, 37.17435, 57.21962, 75.28066, 87.56456, 94.2345, 96.22317,
   97.28925, 97.9049 };
   ...
   Graph_Graph34->SetMinimum(0.223605);
   Graph_Graph34->SetMaximum(109.9752);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph4_fy5[35] = { 100, 0.06155968, 0.03532767, 0.02246499, 0.01177788, 0.005841255, 0.003063679, 0.007343292, 0.01041889, 0.01043081, 0.01273155, 0.01279116, 0.01498461, 0.01884699, 0.01897812, 0.01378059, 0.02211332,
   0.01585484, 0.02242327, 0.0135541, 0.01157522, 0.01575947, 0.02338886, 0.03856421, 0.04866123, 0.07065535, 0.07612705, 0.09434223, 0.114584, 0.1428723, 0.222826, 0.5407572, 0.717175,
   0.8909106, 1.09328 };
   ...
   Graph_Graph45->SetMinimum(0.002757311);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph5_fy6[35] = { 100, 0.3929019, 0.7430077, 0.4698277, 0.1690209, 0.009208918, 0.08580685, 0.1518607, 0.1263618, 0.1560092, 0.1793265, 0.1962781, 0.210011, 0.3354907, 0.2634168, 0.2767682, 0.4832387,
   0.287056, 0.4381776, 0.5067468, 0.4560232, 0.4639864, 0.4232526, 0.3845692, 0.562942, 0.338769, 0.4014254, 0.3073454, 0.0451386, 0.0687778, 0.04835129, 0.2701402, 1.122332,
   1.732159, 2.34977 };
   ...
   Graph_Graph56->SetMinimum(0.008288026);
   Graph_Graph56->SetMaximum(109.9991);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph6_fy7[35] = { 100, 0.07323623, 0.08850694, 0.06266236, 0.03740191, 0.03470182, 0.03281832, 0.01585484, 0.0148654, 0.03379583, 0.0502944, 0.06835461, 0.07362366, 0.1066446, 0.08924007, 0.1080751, 0.1370788,
   0.1167059, 0.1459956, 0.1556158, 0.1679063, 0.1510859, 0.1880407, 0.2153516, 0.2675891, 0.2407551, 0.2534151, 0.2209187, 0.2101541, 0.1783609, 0.2089381, 0.3685236, 0.523293,
   0.7208228, 0.8456349 };
   ...
   Graph_Graph67->SetMinimum(0.01337886);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph7_fy8[35] = { 244.949, 22.1576, 6.753453, 2.793769, 4.07611, 2.701679, 3.548723, 4.250998, 2.628546, 4.046163, 4.195296, 11.5364, 19.23444, 32.45801, 18.5144, 8.883193, 26.41063,
   23.56173, 15.47094, 18.75472, 9.511841, 23.48728, 8.446139, 11.76403, 19.112, 24.47615, 30.4078, 39.15706, 60.99548, 78.38557, 92.28383, 99.20269, 102.3073,
   106.2775, 108.7632 };
   ...
   Graph_Graph78->SetMinimum(2.365692);
   Graph_Graph78->SetMaximum(269.181);
