...
//=========  (Wed Jul  8 12:50:12 2026) by ROOT version 6.32.13
   ...
   2500, 3200 };
   Double_t Graph0_fy1[35] = { 0, 0, 0, 27.28565, 18.40036, 16.39557, 15.64073, 14.45017, 14.18822, 14.14808, 13.69312, 13.53574, 12.77799, 11.40968, 10.82555, 15.28806, 18.37578,
   22.06353, 18.08999, 18.21277, 20.87965, 25.71161, 25.49078, 31.3645, 27.94945, 28.04672, 34.8434, 30.63819, 18.04335, 19.87651, 21.98916, 18.13389, 21.76842,
   16.42176, 0.03114305 };
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph1_fy2[35] = { 100, 100, 100, 49.819, 24.82572, 16.24922, 18.74071, 15.21281, 11.54482, 7.803106, 4.147732, 2.638578, 1.177621, 1.546389, 7.964486, 10.95349, 12.17279,
   20.16466, 15.82013, 19.05118, 22.289, 29.81294, 31.99631, 38.71978, 33.68543, 39.55194, 50.16712, 43.24252, 28.81635, 36.40904, 33.85187, 40.09185, 51.54041,
   53.24852, 62.42375 };
   ...
   Graph_Graph12->SetMinimum(1.059859);
   Graph_Graph12->SetMaximum(109.8822);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph2_fy3[35] = { 100, 100, 100, 13.74618, 11.87263, 12.19329, 11.41621, 10.37163, 5.61893, 11.11537, 6.299245, 1.481855, 1.369739, 2.941728, 2.654374, 6.749397, 14.28319,
   22.31092, 16.23157, 10.88825, 17.68572, 16.17519, 23.60312, 27.44133, 15.72299, 31.84924, 33.79874, 22.97326, 23.1539, 23.07404, 16.16114, 19.61368, 23.47299,
   26.46323, 27.72845 };
   ...
   Graph_Graph23->SetMinimum(1.232765);
   Graph_Graph23->SetMaximum(109.863);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph3_fy4[35] = { 100, 100, 100, 4.614162, 1.879871, 1.026511, 1.614857, 2.199805, 4.447854, 4.642076, 7.115161, 3.499192, 1.248181, 3.529334, 8.616209, 5.098891, 10.11516,
   29.90239, 6.365633, 4.49034, 8.637894, 1.571596, 3.959668, 6.55278, 5.586356, 2.030122, 3.54116, 8.762163, 1.876247, 6.198955, 11.52461, 13.49887, 16.55701,
   14.964, 30.3744 };
   ...
   Graph_Graph34->SetMinimum(0.9238601);
   Graph_Graph34->SetMaximum(109.8973);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph4_fy5[35] = { 100, 100, 100, 0.2198577, 0.2827048, 0.1973152, 0.1788855, 0.1426101, 0.1049638, 0.09437799, 0.1189232, 0.1034379, 0.1176715, 0.1218081, 0.1826048, 0.2979875, 0.3284216,
   0.390172, 0.2930045, 0.2833724, 0.1599491, 0.3719687, 0.643456, 0.8845866, 0.9327054, 1.235479, 1.479328, 1.209754, 0.7003367, 0.9316385, 0.982213, 1.227677, 1.884639,
   2.955604, 2.43476 };
   ...
   Graph_Graph45->SetMinimum(0.0849402);
   Graph_Graph45->SetMaximum(109.9906);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph5_fy6[35] = { 100, 100, 100, 1.872206, 1.796281, 1.848173, 1.092529, 1.516509, 1.212144, 0.8887053, 0.9674072, 1.049328, 1.104784, 0.5574703, 0.06098747, 0.507623, 1.039088,
   0.6539404, 0.8137643, 1.042235, 2.230459, 3.716838, 2.779663, 6.512374, 7.524991, 4.758793, 8.524048, 11.88926, 5.077714, 7.640052, 3.807175, 1.738173, 9.738517,
   6.584245, 12.05113 };
   ...
   Graph_Graph56->SetMinimum(0.05488873);
   Graph_Graph56->SetMaximum(109.9939);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph6_fy7[35] = { 100, 100, 100, 22.29569, 18.53412, 15.5869, 12.81056, 10.97511, 6.922579, 6.429935, 2.97358, 4.80268, 2.121651, 1.425135, 4.098475, 10.01112, 11.23598,
   18.93197, 12.32203, 15.05832, 16.35327, 22.14207, 29.79752, 32.31992, 24.90603, 34.20319, 36.50522, 22.73802, 15.8278, 30.37584, 16.98028, 27.86921, 14.83312,
   24.26416, 22.81322 };
   ...
   Graph_Graph67->SetMinimum(1.282622);
   Graph_Graph67->SetMaximum(109.8575);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph7_fy8[35] = { 244.949, 244.949, 244.949, 62.74822, 38.02898, 30.47931, 29.90185, 25.98884, 20.86496, 21.17309, 17.45862, 15.12601, 13.18461, 12.49155, 16.69566, 22.93089, 30.32502,
   51.42317, 32.15726, 32.57743, 39.90723, 48.14799, 56.05678, 66.08093, 53.59203, 67.55369, 79.32954, 63.82003, 44.41127, 57.21418, 48.24169, 57.30909, 65.37435,
   68.33842, 79.11888 };
   ...
   Graph_Graph78->SetMinimum(11.24239);
   Graph_Graph78->SetMaximum(268.1947);
