...
//=========  (Wed Jul  8 12:54:07 2026) by ROOT version 6.32.13
   ...
   2500, 3200 };
   Double_t Graph0_fy1[35] = { 0, 0, 0, 48.739, 32.48202, 29.24691, 28.75993, 26.63333, 26.48315, 26.19661, 25.78868, 24.95683, 24.29805, 22.24689, 20.17152, 20.74252, 25.40783,
   25.68792, 22.87941, 22.87444, 23.00408, 24.42544, 29.23687, 31.56952, 29.26456, 30.09402, 31.17776, 29.07635, 26.75067, 24.27399, 19.80585, 18.85359, 20.00677,
   24.69351, 0.09057959 };
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph1_fy2[35] = { 100, 100, 100, 97.64981, 69.05433, 47.73362, 46.89495, 39.44286, 31.1807, 28.90638, 19.92356, 15.30596, 12.96022, 7.234412, 3.737152, 8.270735, 15.47922,
   25.28911, 22.52409, 26.0584, 29.73791, 37.52509, 44.63139, 51.71676, 44.75823, 51.82613, 57.82833, 50.66149, 44.60807, 44.47488, 41.75395, 44.18711, 57.75225,
   62.69698, 65.15104 };
   ...
   Graph_Graph12->SetMinimum(3.363436);
   Graph_Graph12->SetMaximum(109.6263);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph2_fy3[35] = { 100, 100, 100, 8.71523, 5.445719, 8.083164, 12.16541, 10.95496, 11.46533, 12.01255, 16.19073, 18.54002, 15.03172, 10.36869, 8.751613, 0.9095788, 18.26786,
   34.14009, 4.594839, 17.34267, 16.72735, 15.56398, 15.66572, 17.83572, 8.070374, 18.52295, 15.2868, 7.197261, 13.03793, 13.36704, 12.60428, 8.356487, 11.16073,
   25.63398, 21.51781 };
   ...
   Graph_Graph23->SetMinimum(0.8186209);
   Graph_Graph23->SetMaximum(109.909);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph3_fy4[35] = { 100, 100, 100, 7.918328, 3.335518, 0.6757379, 1.009059, 1.773942, 1.981789, 4.71521, 0.9625435, 2.037013, 3.930777, 4.240376, 0.7893085, 3.218883, 2.978164,
   15.36713, 7.939881, 2.68991, 0.7967532, 1.84654, 3.076267, 2.534807, 0.7523119, 6.118596, 5.864608, 6.438732, 3.981662, 11.96123, 2.335048, 17.2682, 18.67205,
   10.37835, 3.559315 };
   ...
   Graph_Graph34->SetMinimum(0.6081641);
   Graph_Graph34->SetMaximum(109.9324);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph4_fy5[35] = { 100, 100, 100, 0.03012419, 0.068748, 0.09707212, 0.1615405, 0.1160383, 0.0182569, 0.1041055, 0.07348061, 0.06043911, 0.1021266, 0.115937, 0.08416176, 0.03453493, 0.02319813,
   0.03031492, 0.0526011, 0.02650023, 0.06446838, 0.1092553, 0.0988245, 0.1023531, 0.1268744, 0.1350462, 0.110054, 0.1557231, 0.1016378, 0.2261639, 0.1507103, 0.1928031, 0.2128005,
   0.1650453, 0.0705719 };
   ...
   Graph_Graph45->SetMinimum(0.01643121);
   Graph_Graph45->SetMaximum(109.9982);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph5_fy6[35] = { 100, 100, 100, 3.671467, 1.884401, 0.2477646, 0.5378425, 1.070231, 2.077979, 2.340186, 2.736223, 3.382248, 2.54035, 0.6509781, 0.7824421, 2.068484, 5.866587,
   5.432701, 4.71468, 7.816112, 4.821503, 3.505516, 0.9766996, 1.246691, 1.791376, 1.800221, 4.533529, 7.986659, 0.8055568, 3.820008, 6.063306, 7.554674, 16.60612,
   23.71101, 17.53763 };
   ...
   Graph_Graph56->SetMinimum(0.2229881);
   Graph_Graph56->SetMaximum(109.9752);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph6_fy7[35] = { 100, 100, 100, 76.84608, 66.60843, 37.77341, 19.54318, 33.51894, 32.89544, 25.97288, 9.827971, 4.494381, 12.60217, 17.11626, 26.44182, 27.74524, 33.49254,
   28.60203, 15.36833, 10.21388, 9.937727, 31.64819, 61.26411, 86.91075, 82.5638, 98.19818, 95.48549, 103.142, 114.1957, 100.8544, 8.579123, 51.6484, 72.79953,
   195.2049, 118.9979 };
   ...
   Graph_Graph67->SetMinimum(4.044943);
   Graph_Graph67->SetMaximum(214.2759);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph7_fy8[35] = { 244.949, 244.949, 244.949, 134.0464, 101.5116, 68.01893, 59.64509, 59.2698, 53.80895, 48.66676, 37.80412, 35.1659, 34.13275, 31.08303, 34.61011, 35.83188, 48.82536,
   59.57091, 37.05904, 40.93531, 42.61431, 57.13396, 82.8003, 107.4748, 98.71888, 116.6974, 117.1422, 119.1947, 126.2246, 114.347, 49.09554, 73.48911, 98.91603,
   209.6966, 138.5223 };
   ...
   Graph_Graph78->SetMinimum(9.696441);
   Graph_Graph78->SetMaximum(266.3356);
