...
//=========  (Wed Jul  8 12:50:01 2026) by ROOT version 6.32.13
   ...
   2500, 3200 };
   Double_t Graph0_fy1[35] = { 0, 0, 78.54828, 17.31128, 11.83116, 10.52368, 10.14352, 10.08498, 10.03954, 10.05448, 9.865214, 9.764613, 9.98483, 10.04459, 10.16243, 10.2761, 8.770208,
   7.47051, 14.75863, 20.04502, 19.7653, 37.03122, 49.72396, 41.95574, 28.92284, 43.45834, 59.67247, 46.11581, 30.38231, 45.56152, 33.24766, 43.0322, 41.68419,
   28.80618, 0.01271116 };
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph1_fy2[35] = { 100, 100, 74.30264, 46.81038, 10.41478, 6.625092, 5.991054, 4.434741, 1.455796, 0.5632281, 0.6719947, 0.8960485, 2.344799, 2.525973, 4.695117, 6.806147, 5.665946,
   6.674981, 8.608747, 9.530759, 9.482985, 15.05703, 21.28723, 19.25635, 15.04078, 26.28448, 36.4224, 26.78744, 21.12159, 31.9711, 32.08542, 41.25349, 46.04934,
   52.28475, 63.84407 };
   ...
   Graph_Graph12->SetMinimum(0.5069053);
   Graph_Graph12->SetMaximum(109.9437);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph2_fy3[35] = { 100, 100, 100, 5.118555, 6.012738, 6.898272, 3.559601, 3.701985, 4.668224, 0.898397, 4.470944, 2.669275, 4.437709, 4.144901, 3.190243, 4.984343, 10.34616,
   20.04853, 13.64954, 9.632551, 19.11693, 19.46729, 13.47823, 16.78652, 20.13954, 19.85053, 30.37947, 19.05906, 28.63737, 27.72728, 16.87643, 18.77685, 26.61514,
   26.82015, 36.60276 };
   ...
   Graph_Graph23->SetMinimum(0.8085573);
   Graph_Graph23->SetMaximum(109.9102);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph3_fy4[35] = { 100, 100, 50.19588, 0.8817375, 3.280109, 1.268077, 0.6408155, 1.350856, 2.368373, 1.783907, 3.948522, 4.81925, 3.829646, 3.875494, 5.446041, 3.577435, 8.211946,
   23.68788, 7.240772, 9.770203, 13.14296, 5.615675, 1.065171, 14.38696, 10.01939, 9.696781, 2.209359, 8.052402, 10.19681, 11.81791, 20.56943, 10.22533, 11.96626,
   14.8379, 18.48246 };
   ...
   Graph_Graph34->SetMinimum(0.5767339);
   Graph_Graph34->SetMaximum(109.9359);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph4_fy5[35] = { 100, 100, 0.4855633, 0.1394629, 0.05816221, 0.02473593, 0.04600286, 0.03044605, 0.004780293, 0.03752112, 0.01789927, 0.02965927, 0.04072189, 0.01621246, 0.03486872, 0.02913475, 0.01484156,
   0.03020763, 0.06614327, 0.06060004, 0.03817677, 0.0123322, 0.03757477, 0.0112772, 0.005275011, 0.05987287, 0.1052976, 0.1184702, 0.1302421, 0.3133595, 0.2687156, 0.1975775, 0.2208471,
   0.2230346, 0.1838207 };
   ...
   Graph_Graph45->SetMinimum(0.004302263);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph5_fy6[35] = { 100, 100, 2.42821, 1.463568, 1.826942, 1.76307, 1.624656, 1.604497, 1.050627, 0.9074569, 0.4693627, 0.4137397, 0.3156662, 0.1690984, 0.3415346, 0.5699396, 0.1808882,
   1.159048, 3.1398, 4.767561, 3.98432, 7.910275, 10.81796, 6.995434, 2.480835, 6.434196, 11.15968, 7.199061, 1.531559, 8.502996, 11.1803, 16.81633, 12.89359,
   11.28315, 20.36005 };
   ...
   Graph_Graph56->SetMinimum(0.1521885);
   Graph_Graph56->SetMaximum(109.9831);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph6_fy7[35] = { 100, 100, 3.036368, 2.493185, 1.86075, 1.800096, 1.495874, 1.163852, 0.6723881, 0.2229452, 0.2069592, 0.1749039, 0.2384424, 0.5347252, 1.166224, 1.798314, 1.41722,
   2.447498, 2.004623, 2.150112, 2.26925, 2.944499, 3.98764, 4.062634, 3.245753, 4.88745, 5.232632, 3.705281, 3.461075, 3.796703, 2.137876, 2.459115, 4.196298,
   3.99065, 3.557646 };
   ...
   Graph_Graph67->SetMinimum(0.1574135);
   Graph_Graph67->SetMaximum(109.9825);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph7_fy8[35] = { 244.949, 244.949, 155.646, 50.26178, 17.38274, 14.4977, 12.51976, 11.86731, 11.48343, 10.30892, 11.55931, 11.25626, 11.82001, 11.82323, 12.90868, 13.89688, 16.89793,
   32.72243, 23.33554, 26.61273, 32.24614, 45.6046, 56.93283, 51.81992, 39.81752, 55.97197, 77.24712, 57.77451, 48.03771, 63.97877, 54.52007, 65.57152, 69.95408,
   68.16347, 78.64256 };
   ...
   Graph_Graph78->SetMinimum(9.278029);
   Graph_Graph78->SetMaximum(268.413);
