...
//=========  (Wed Jun 10 11:23:02 2026) by ROOT version 6.32.13
   ...
   2500, 3200 };
   Double_t Graph0_fy1[35] = { 5.50287, 2.647719, 2.505899, 2.365743, 2.283319, 2.207065, 2.08997, 2.086245, 2.111313, 2.156233, 2.227691, 2.357304, 2.351985, 2.737299, 2.546643, 2.802644, 2.935647,
   2.99842, 3.311941, 2.902403, 3.064357, 2.745698, 2.613517, 2.598302, 2.810881, 3.331978, 4.431486, 5.687263, 7.705122, 10.47858, 14.44644, 23.58179, 29.15326,
   44.07222, 1.112731e-06 };
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph1_fy2[35] = { 3.458214, 3.494525, 1.248926, 1.302099, 1.639628, 2.226019, 3.534979, 3.935969, 3.777516, 2.979243, 3.177649, 7.794762, 11.96792, 13.06407, 5.056757, 6.213975, 5.457044,
   4.154718, 7.310116, 1.623207, 8.641493, 0.6724834, 2.15435, 4.764104, 5.835009, 7.893646, 5.853009, 6.620622, 4.520035, 9.531916, 15.76607, 18.33523, 27.48221,
   34.11409, 51.15439 };
   ...
   Graph_Graph12->SetMinimum(0.6052351);
   Graph_Graph12->SetMaximum(56.20258);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph2_fy3[35] = { 85.08524, 9.825289, 5.059707, 2.024853, 1.58962, 1.629609, 1.111102, 1.874983, 2.018058, 1.993304, 2.639937, 2.895045, 2.391279, 2.256417, 5.005395, 3.554028, 5.445325,
   4.19389, 1.954466, 2.49697, 2.448368, 3.149956, 4.442847, 2.538419, 6.626296, 6.562376, 9.425629, 13.54369, 8.414232, 9.382689, 4.233599, 1.935625, 6.549907,
   23.25409, 27.26004 };
   ...
   Graph_Graph23->SetMinimum(0.9999919);
   Graph_Graph23->SetMaximum(93.48265);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph3_fy4[35] = { 5.471158, 3.407246, 2.105975, 1.32277, 7.014531, 1.545393, 0.1051426, 0.813961, 5.339324, 2.869296, 1.810861, 0.9783447, 0.6364405, 1.929319, 7.290339, 3.544843, 2.049124,
   15.96141, 10.06615, 3.405392, 4.094696, 7.007658, 2.140731, 1.607239, 6.926954, 6.917209, 6.83192, 8.820164, 5.889142, 20.82222, 10.45647, 10.35675, 64.40878,
   1251.781, 15631.26 };
   ...
   Graph_Graph34->SetMinimum(0.09462833);
   Graph_Graph34->SetMaximum(17194.37);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph4_fy5[35] = { 0.1960874, 1.561368, 1.849943, 0.5338669, 1.477039, 1.516896, 2.615184, 4.128695, 2.57647, 2.363563, 1.675159, 7.479632, 10.04138, 13.14228, 4.032212, 3.042448, 1.798916,
   0.9881854, 2.50119, 3.157169, 3.634322, 3.053939, 0.8415282, 2.271831, 4.142451, 7.534826, 7.422817, 10.42452, 10.98557, 1.256394, 0.6553948, 5.976498, 7.251859,
   29.74096, 51.64545 };
   ...
   Graph_Graph45->SetMinimum(0.1764786);
   Graph_Graph45->SetMaximum(56.79038);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph5_fy6[35] = { 1.782584, 0.1172423, 2.88617, 0.1721203, 1.08881, 1.648718, 2.647102, 4.211223, 2.399242, 2.125746, 1.425284, 7.955074, 9.739578, 13.66302, 3.451771, 3.74279, 2.388334,
   0.06062984, 3.175986, 2.35948, 4.413307, 2.135187, 0.1520872, 3.340435, 5.354238, 8.910858, 8.914161, 12.18902, 12.74351, 2.261031, 0.1635075, 3.075922, 0.9955704,
   5.076373, 1.333123 };
   ...
   Graph_Graph56->SetMinimum(0.05456686);
   Graph_Graph56->SetMaximum(15.02326);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph6_fy7[35] = { 0.3281534, 1.70871, 1.974154, 0.6688714, 1.566553, 1.568472, 2.652466, 4.167521, 2.578497, 2.371132, 1.702285, 7.509553, 10.11898, 13.22489, 4.170447, 3.159487, 1.931345,
   1.180184, 2.686954, 3.416914, 3.85524, 3.371811, 1.226473, 2.705455, 4.725385, 8.341146, 8.603418, 12.07076, 13.10836, 4.015875, 4.838395, 9.582985, 11.6797,
   36.06559, 58.8527 };
   ...
   Graph_Graph67->SetMinimum(0.295338);
   Graph_Graph67->SetMaximum(64.70515);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph7_fy8[35] = { 85.52775, 11.52124, 7.316055, 3.728804, 8.090346, 4.727528, 6.244322, 8.727607, 8.387575, 6.438854, 5.748383, 15.85166, 21.28306, 26.8565, 12.483, 10.24269, 9.215105,
   17.34879, 13.89664, 7.490024, 12.42478, 9.606002, 6.166753, 7.881235, 14.21253, 19.23736, 19.94975, 27.20938, 25.30197, 27.29607, 24.66569, 33.76838, 77.37295,
   1254.118, 15631.56 };
   ...
   Graph_Graph78->SetMinimum(3.355924);
   Graph_Graph78->SetMaximum(17194.35);
