...
//=========  (Wed Jun 10 11:22:39 2026) by ROOT version 6.32.13
   ...
   2500, 3200 };
   Double_t Graph0_fy1[35] = { 5.336235, 2.527366, 2.346198, 2.271109, 2.183406, 2.081706, 1.967812, 1.958884, 1.940062, 1.955656, 2.018744, 2.108365, 2.144446, 2.44053, 2.350975, 2.548773, 2.719505,
   2.665102, 3.069682, 2.649433, 2.948527, 2.497456, 2.416701, 2.202515, 2.31339, 2.275928, 2.396232, 2.517704, 2.954031, 3.733255, 4.846066, 7.799084, 9.337911,
   11.89754, 5.946132e-06 };
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph1_fy2[35] = { 2.639484, 2.84127, 1.977319, 0.7780552, 1.280689, 2.251196, 3.55522, 3.769255, 3.954351, 3.456581, 2.27682, 7.462323, 12.3543, 15.25509, 5.731219, 5.704439, 4.031694,
   1.715493, 6.956887, 0.3804564, 8.802867, 2.641064, 5.458784, 7.639992, 8.377171, 11.06912, 9.539151, 11.08099, 10.84119, 5.551934, 5.802727, 11.31434, 15.74824,
   41.55259, 66.60193 };
   ...
   Graph_Graph12->SetMinimum(0.3424108);
   Graph_Graph12->SetMaximum(73.22408);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph2_fy3[35] = { 85.23164, 11.60941, 4.161751, 1.949191, 1.423597, 1.848078, 1.326966, 1.425385, 1.995945, 2.286839, 2.35287, 2.474236, 3.292823, 2.514172, 3.714085, 2.708024, 6.8174,
   4.968715, 2.368373, 4.309094, 3.362525, 0.6079495, 6.582248, 4.13177, 8.010519, 6.123888, 7.475054, 10.09334, 3.076184, 3.826392, 8.684796, 3.386849, 4.474652,
   19.87284, 15.07404 };
   ...
   Graph_Graph23->SetMinimum(0.5471545);
   Graph_Graph23->SetMaximum(93.69401);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph3_fy4[35] = { 3.940988, 4.264021, 3.015888, 0.6255627, 7.325006, 0.9087801, 0.3189206, 1.10746, 6.098157, 2.436018, 1.72838, 0.1741707, 1.817417, 1.446104, 6.490767, 5.630696, 2.213037,
   18.14362, 10.82976, 5.821419, 7.35265, 8.337545, 1.799321, 3.295779, 8.231247, 7.645899, 6.763339, 8.602595, 3.190982, 16.53029, 7.176805, 8.328891, 7.250619,
   231.8863, 2846.56 };
   ...
   Graph_Graph34->SetMinimum(0.1567537);
   Graph_Graph34->SetMaximum(3131.198);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph4_fy5[35] = { 1.517475, 1.044261, 2.612036, 0.02888441, 1.166725, 1.864839, 2.927601, 4.239297, 3.135377, 2.584296, 1.187927, 7.327151, 10.52109, 15.31725, 4.890823, 3.979957, 2.578151,
   0.9258747, 4.17186, 1.859689, 5.677378, 3.82064, 1.831579, 4.277313, 5.392098, 8.396387, 7.163978, 8.78886, 8.478821, 3.500175, 4.526269, 2.831817, 2.653742,
   16.27281, 21.1938 };
   ...
   Graph_Graph45->SetMinimum(0.02599597);
   Graph_Graph45->SetMaximum(23.31029);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph5_fy6[35] = { 2.674544, 0.2824724, 3.503281, 0.5811751, 0.9090662, 1.930237, 2.887559, 4.376554, 2.908742, 2.364796, 0.9717047, 7.648718, 10.24415, 15.63008, 4.618484, 4.278779, 2.916062,
   0.5301058, 4.505944, 1.490051, 6.055522, 3.422016, 2.277243, 4.691136, 5.737686, 8.721685, 7.465792, 9.068775, 8.703506, 3.33643, 4.322261, 2.780426, 2.534926,
   16.69468, 22.5801 };
   ...
   Graph_Graph56->SetMinimum(0.2542251);
   Graph_Graph56->SetMaximum(24.80986);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph6_fy7[35] = { 1.636893, 1.153755, 2.729416, 0.1418114, 1.220763, 1.898575, 2.95127, 4.250276, 3.142095, 2.60061, 1.215732, 7.361102, 10.56462, 15.37262, 4.953938, 4.060602, 2.674878,
   1.010197, 4.286873, 1.981711, 5.827463, 3.965104, 2.013719, 4.452991, 5.581939, 8.596289, 7.387471, 9.032583, 8.688569, 3.688759, 4.60729, 2.700293, 2.438521,
   15.97166, 20.93095 };
   ...
   Graph_Graph67->SetMinimum(0.1276302);
   Graph_Graph67->SetMaximum(23.00986);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph7_fy8[35] = { 85.60107, 13.03542, 7.897823, 3.211338, 8.109727, 4.944763, 6.632742, 8.746052, 9.419988, 6.780146, 4.649292, 15.25318, 22.32981, 31.0213, 12.80978, 11.34511, 9.865597,
   19.13331, 15.38829, 8.320295, 15.95035, 11.18599, 9.736422, 12.29982, 17.33795, 21.0744, 18.97345, 23.36839, 19.2103, 19.2261, 15.636, 17.10914, 20.66911,
   238.3967, 2847.624 };
   ...
   Graph_Graph78->SetMinimum(2.890204);
   Graph_Graph78->SetMaximum(3132.065);
