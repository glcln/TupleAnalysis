...
//=========  (Tue Jun  9 10:40:00 2026) by ROOT version 6.32.13
   ...
   2500, 3200 };
   Double_t Graph0_fy1[35] = { 2.495263, 1.937895, 1.878622, 1.907272, 2.112407, 2.309292, 2.296036, 2.276809, 2.313756, 2.425988, 2.619128, 2.966746, 3.301557, 3.603608, 3.91014, 4.247293, 4.670152,
   4.98365, 5.493809, 4.988373, 5.490139, 5.507812, 5.735044, 6.27615, 6.94192, 7.339822, 8.453224, 9.765733, 12.06292, 14.55913, 17.5577, 25.61805, 30.45125,
   39.61767, 5.764448e-10 };
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph1_fy2[35] = { 1.19561, 1.484478, 0.8107543, 0.1382828, 0.6140232, 2.211785, 2.406704, 3.748995, 3.367496, 3.432745, 4.73721, 3.305852, 4.526133, 2.033973, 2.111745, 2.369463, 5.171359,
   3.649682, 6.277037, 1.721954, 7.907271, 5.23653, 6.992161, 12.18419, 15.87936, 22.75809, 26.21186, 35.46674, 42.79461, 36.86774, 48.64865, 77.52512, 98.93517,
   188.858, 288.0524 };
   ...
   Graph_Graph12->SetMinimum(0.1244545);
   Graph_Graph12->SetMaximum(316.8438);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph2_fy3[35] = { 9.442139, 3.711319, 1.329637, 0.7419944, 0.442034, 1.766771, 1.581132, 4.165113, 2.216494, 3.13772, 1.793873, 3.760755, 2.028888, 1.896429, 2.287161, 2.43361, 2.128851,
   2.567738, 1.862359, 3.750801, 3.227913, 3.037059, 5.568659, 5.758202, 9.188641, 9.189224, 11.24153, 12.87125, 6.239974, 9.31685, 5.849093, 9.419042, 6.209439,
   17.8358, 4.462248 };
   ...
   Graph_Graph23->SetMinimum(0.3978306);
   Graph_Graph23->SetMaximum(19.57517);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph3_fy4[35] = { 1.645744, 0.7438183, 0.6529212, 0.4045486, 2.02865, 0.04419088, 3.425312, 1.256579, 1.63188, 3.365058, 0.3257871, 3.083158, 2.538693, 1.685941, 6.427765, 2.548635, 4.089701,
   10.10445, 15.10224, 6.883347, 7.819116, 13.13905, 1.803935, 7.701397, 9.445583, 2.944475, 8.870721, 7.278287, 3.854787, 17.53749, 5.010188, 1.94869, 10.02489,
   16.39152, 42.50804 };
   ...
   Graph_Graph34->SetMinimum(0.0397718);
   Graph_Graph34->SetMaximum(46.75442);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph4_fy5[35] = { 0.5273581, 0.8838058, 0.4482627, 0.1235604, 0.1346231, 1.361126, 1.242292, 2.407992, 1.976418, 2.276874, 3.47417, 1.991194, 3.274012, 0.05381107, 1.307952, 0.2090752, 2.274048,
   3.960317, 2.590132, 2.324885, 2.907395, 0.3534198, 0.1266479, 3.546572, 4.908955, 8.18671, 7.02337, 9.480977, 7.548285, 6.217628, 10.67938, 8.172094, 13.27788,
   4.964608, 7.45697 };
   ...
   Graph_Graph45->SetMinimum(0.04842997);
   Graph_Graph45->SetMaximum(14.60029);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph5_fy6[35] = { 0.8752763, 0.1578569, 0.3599644, 0.3367066, 0.2069116, 0.8506536, 0.4669845, 1.388621, 0.7019341, 0.8491874, 1.94751, 0.3164351, 1.459461, 2.03234, 0.7765174, 2.008474, 4.643834,
   1.61314, 5.155301, 0.3211617, 5.612218, 2.518296, 3.121638, 6.684339, 8.183516, 11.60016, 10.62332, 13.32307, 11.2583, 2.72581, 7.743561, 5.787581, 11.20134,
   1.563507, 7.569671 };
   ...
   Graph_Graph56->SetMinimum(0.1420712);
   Graph_Graph56->SetMaximum(14.63959);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph6_fy7[35] = { 0.5556583, 0.9103537, 0.4659772, 0.1249194, 0.1474023, 1.389039, 1.279849, 2.453381, 2.039886, 2.35793, 3.578234, 2.121675, 3.428388, 0.2061248, 1.503837, 0.4267991, 2.473521,
   4.210103, 2.822495, 2.620977, 3.177381, 0.6990612, 0.4670501, 3.921866, 5.333424, 8.673656, 7.596612, 10.15061, 8.264494, 6.919992, 11.28557, 8.680094, 13.72553,
   5.383009, 7.657433 };
   ...
   Graph_Graph67->SetMinimum(0.1124275);
   Graph_Graph67->SetMaximum(15.08559);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph7_fy8[35] = { 10.04347, 4.681991, 2.632191, 2.124916, 3.038547, 4.225395, 5.356876, 7.204981, 5.729699, 7.092472, 7.82889, 7.207349, 8.15785, 5.266656, 8.418502, 6.350724, 10.13241,
   13.52263, 18.50356, 10.08344, 14.63797, 15.70258, 11.22604, 18.78703, 24.36201, 30.68768, 34.40162, 44.07187, 47.77779, 45.38216, 55.09678, 83.27406, 106.5113,
   194.6272, 291.5005 };
   ...
   Graph_Graph78->SetMinimum(1.912424);
   Graph_Graph78->SetMaximum(320.4381);
