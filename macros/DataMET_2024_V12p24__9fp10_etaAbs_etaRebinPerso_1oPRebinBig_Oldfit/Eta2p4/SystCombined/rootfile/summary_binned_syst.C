...
//=========  (Tue Jun  9 10:36:38 2026) by ROOT version 6.32.13
   ...
   2500, 3200 };
   Double_t Graph0_fy1[35] = { 2.358613, 1.73164, 1.554477, 1.384758, 1.337765, 1.338265, 1.331613, 1.41446, 1.529523, 1.662002, 1.775959, 1.966357, 1.997752, 2.228774, 2.164148, 2.370668, 2.563935,
   2.571017, 2.829585, 2.444193, 2.640584, 2.250796, 2.155375, 2.011496, 2.036471, 1.92581, 2.020818, 2.208135, 2.772315, 3.656134, 4.803404, 7.746822, 9.192891,
   11.51151, 2.179614e-06 };
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph1_fy2[35] = { 0.6159186, 0.4920959, 0.6645501, 0.4279613, 0.6772757, 1.940173, 2.386761, 3.060889, 3.095543, 2.757746, 1.594448, 6.932688, 13.20161, 15.82036, 7.973981, 5.19278, 5.013084,
   1.660478, 7.088125, 1.801348, 11.12322, 1.53724, 6.869078, 9.450018, 10.94625, 14.05312, 13.49059, 15.85697, 17.00516, 6.64556, 9.387112, 23.0669, 30.1401,
   65.68006, 106.4335 };
   ...
   Graph_Graph12->SetMinimum(0.3851652);
   Graph_Graph12->SetMaximum(117.0341);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph2_fy3[35] = { 13.34623, 1.56666, 1.229024, 0.7196069, 0.4552126, 1.638854, 1.108265, 1.543325, 1.180816, 1.399237, 1.454818, 1.303959, 3.241777, 3.376567, 3.636765, 2.045667, 7.885206,
   4.213822, 2.838409, 4.887748, 4.486632, 0.7968485, 7.144976, 3.993332, 8.122169, 6.214678, 7.577848, 10.38561, 3.275967, 5.750632, 5.501282, 5.894375, 8.503496,
   36.51967, 36.96297 };
   ...
   Graph_Graph23->SetMinimum(0.4096913);
   Graph_Graph23->SetMaximum(40.61375);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph3_fy4[35] = { 0.2661228, 1.489586, 1.405245, 0.2802789, 4.277688, 0.9479642, 0.7193267, 0.005620718, 4.004765, 2.869213, 3.108215, 1.284611, 0.1110733, 3.178287, 8.541822, 7.969403, 4.612303,
   19.85649, 13.57017, 7.116568, 9.035004, 9.982014, 2.642655, 4.511344, 10.32021, 6.317627, 8.748484, 10.83434, 4.634023, 18.99289, 8.953751, 9.53989, 9.914684,
   246.7589, 3579.123 };
   ...
   Graph_Graph34->SetMinimum(0.005058646);
   Graph_Graph34->SetMaximum(3937.034);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph4_fy5[35] = { 0.3473043, 0.2263069, 0.5445719, 0.1548409, 0.5507588, 1.545858, 2.056217, 2.845931, 2.532375, 2.279985, 0.8654475, 7.041359, 9.386081, 15.50202, 4.416418, 4.237902, 3.811848,
   1.203692, 4.850459, 1.68485, 6.418657, 3.046966, 2.170312, 4.783821, 6.152964, 8.876514, 7.841158, 9.227586, 8.819067, 3.357965, 4.853952, 1.329517, 0.6257892,
   14.08633, 23.00091 };
   ...
   Graph_Graph45->SetMinimum(0.1393569);
   Graph_Graph45->SetMaximum(25.28551);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph5_fy6[35] = { 2.221537, 0.9105504, 1.034659, 0.2773345, 0.6321549, 1.296657, 1.723266, 3.251994, 2.039796, 1.663899, 0.2532005, 7.881153, 8.892345, 16.43776, 3.458279, 5.248034, 4.873097,
   0.02036095, 6.079113, 0.346458, 7.794929, 1.649827, 3.639448, 6.36543, 7.874227, 10.72805, 9.789896, 11.41459, 10.97147, 1.187164, 2.676308, 3.779554, 3.090322,
   17.12996, 26.28546 };
   ...
   Graph_Graph56->SetMinimum(0.01832485);
   Graph_Graph56->SetMaximum(28.91197);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph6_fy7[35] = { 0.3659725, 0.2274513, 0.5541384, 0.1538336, 0.5503297, 1.541847, 2.050555, 2.85008, 2.528429, 2.27381, 0.858587, 7.038713, 9.383238, 15.49939, 4.419118, 4.248726, 3.833258,
   1.219195, 4.880929, 1.731324, 6.478715, 3.113389, 2.276683, 4.924166, 6.353045, 9.136748, 8.175087, 9.638143, 9.272695, 3.659844, 5.145079, 1.758802, 1.024127,
   14.54141, 23.40035 };
   ...
   Graph_Graph67->SetMinimum(0.1384503);
   Graph_Graph67->SetMaximum(25.72501);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph7_fy8[35] = { 13.75954, 2.974235, 2.831499, 1.679777, 4.664758, 3.948163, 4.540699, 6.367838, 6.805949, 5.804719, 4.36166, 14.71448, 21.0716, 32.0546, 14.33352, 12.79979, 12.96633,
   20.5995, 18.29645, 9.471578, 19.40087, 11.37558, 11.53271, 14.74106, 20.89659, 23.60291, 23.32804, 28.10512, 24.76286, 21.84972, 16.69789, 27.14764, 34.2715,
   259.5638, 3581.142 };
   ...
   Graph_Graph78->SetMinimum(1.511799);
   Graph_Graph78->SetMaximum(3939.089);
