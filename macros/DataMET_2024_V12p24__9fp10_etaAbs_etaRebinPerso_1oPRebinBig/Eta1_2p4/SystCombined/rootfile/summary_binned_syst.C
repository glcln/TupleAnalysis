...
//=========  (Sat Jun  6 11:51:49 2026) by ROOT version 6.32.13
   ...
   2500, 3200 };
   Double_t Graph0_fy1[35] = { 5.399679, 2.39839, 2.193303, 2.068999, 1.978153, 1.917037, 1.881951, 1.890083, 1.911482, 1.96051, 2.006205, 2.086692, 2.15691, 2.309714, 2.517258, 2.578154, 2.66729,
   2.822727, 2.980269, 2.695655, 3.106406, 2.845685, 3.221651, 3.368416, 3.067711, 2.911101, 2.823781, 2.512859, 2.422832, 2.264258, 2.097382, 2.431015, 1.971123,
   1.800016, 0.001383286 };
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph1_fy2[35] = { 4.488504, 3.900182, 2.394032, 1.448917, 1.727259, 2.407235, 3.790921, 4.459798, 5.127382, 4.348069, 1.431054, 8.102858, 15.78543, 24.1424, 9.736443, 5.102408, 3.504467,
   5.124903, 7.668924, 1.540828, 6.897318, 6.793094, 10.42327, 16.92529, 18.01574, 26.57213, 26.39445, 30.425, 32.32534, 21.31845, 30.47912, 45.81354, 48.61181,
   48.23656, 44.80146 };
   ...
   Graph_Graph12->SetMinimum(1.287948);
   Graph_Graph12->SetMaximum(53.32988);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph2_fy3[35] = { 72.06796, 10.60556, 5.001581, 1.534188, 1.543701, 2.533013, 1.669413, 0.7193863, 1.06405, 2.540493, 1.716864, 3.247809, 5.292523, 3.566438, 2.594185, 6.513631, 8.655846,
   7.516331, 8.434606, 9.32399, 3.844595, 3.737545, 13.31672, 10.98155, 18.89311, 19.38591, 23.23315, 28.99529, 23.73419, 27.84349, 29.12078, 44.31354, 48.30362,
   49.45057, 34.51213 };
   ...
   Graph_Graph23->SetMinimum(0.6474477);
   Graph_Graph23->SetMaximum(79.20281);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph3_fy4[35] = { 3.208756, 4.749942, 3.771222, 0.1291156, 8.051401, 0.01190901, 1.390541, 2.706206, 9.073144, 0.4059792, 0.6718814, 0.9761095, 5.62942, 1.003098, 1.305866, 10.90203, 7.579517,
   28.85876, 6.906247, 10.64152, 17.66916, 16.09197, 21.8464, 32.43819, 56.76035, 39.6806, 72.06725, 86.48086, 76.8017, 104.2882, 84.1451, 91.85435, 57.04499,
   25.45987, 45.76506 };
   ...
   Graph_Graph34->SetMinimum(0.01071811);
   Graph_Graph34->SetMaximum(114.7159);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph4_fy5[35] = { 0.3518343, 1.164269, 2.358735, 0.2532125, 1.662946, 2.177066, 3.528571, 4.503393, 4.860532, 3.731906, 1.050985, 8.259857, 15.36486, 22.99271, 8.529573, 4.881918, 3.567529,
   4.421192, 7.46237, 0.4582405, 5.856514, 6.285715, 7.900655, 14.08268, 14.51737, 22.84461, 22.7294, 26.79464, 28.77094, 18.0564, 27.08083, 41.84969, 44.81421,
   43.74362, 40.63505 };
   ...
   Graph_Graph45->SetMinimum(0.2278912);
   Graph_Graph45->SetMaximum(49.2703);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph5_fy6[35] = { 2.184945, 0.6393313, 3.576666, 0.5126834, 1.277649, 2.281463, 3.478122, 4.67751, 4.511273, 3.361768, 0.6633937, 8.804167, 14.8922, 23.55381, 7.950026, 5.440116, 4.137087,
   3.681087, 7.967162, 1.129925, 6.523407, 5.595165, 8.711243, 14.94658, 15.549, 23.84035, 23.76876, 27.86999, 29.8368, 19.02572, 28.07188, 42.97931, 46.0063,
   44.91223, 41.86074 };
   ...
   Graph_Graph56->SetMinimum(0.4614151);
   Graph_Graph56->SetMaximum(50.55566);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph6_fy7[35] = { 0.3794372, 1.183963, 2.39175, 0.2830744, 1.695454, 2.204275, 3.552473, 4.53068, 4.869813, 3.730088, 1.047891, 8.27055, 15.39056, 23.03363, 8.575142, 4.942071, 3.642774,
   4.524368, 7.57755, 0.5852699, 5.983794, 6.458431, 8.073246, 14.2652, 14.70413, 23.04435, 22.9381, 27.01716, 28.98682, 18.25852, 27.24067, 41.98896, 44.94928,
   43.94481, 40.79953 };
   ...
   Graph_Graph67->SetMinimum(0.2547669);
   Graph_Graph67->SetMaximum(49.4159);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph7_fy8[35] = { 72.51504, 12.61624, 8.593982, 3.026155, 9.020916, 5.539822, 7.733148, 9.694843, 13.45695, 8.277101, 3.480597, 17.19454, 31.7531, 47.07346, 17.86224, 16.48682, 13.95998,
   31.25896, 19.05558, 14.54815, 22.29041, 20.96884, 31.25871, 45.78057, 67.68605, 65.46906, 89.69862, 107.1274, 100.3536, 114.5962, 105.4763, 133.669, 118.7421,
   106.2324, 101.7882 };
   ...
   Graph_Graph78->SetMinimum(2.723539);
   Graph_Graph78->SetMaximum(146.7332);
