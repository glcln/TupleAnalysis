...
//=========  (Sat May 30 11:47:16 2026) by ROOT version 6.32.13
   ...
   2500, 3200 };
   Double_t Graph0_fy1[35] = { 7.228228, 3.587748, 3.347048, 3.098759, 2.93131, 2.821355, 2.678339, 2.52751, 2.438071, 2.505809, 2.685119, 2.87268, 3.017267, 3.508448, 3.639254, 4.155286, 4.607579,
   4.7759, 5.267039, 4.757238, 5.437756, 4.801877, 4.815111, 4.876683, 4.933932, 4.646595, 4.706077, 4.446508, 4.274663, 4.206946, 4.11341, 4.874132, 4.267848,
   4.373569, 0.001532698 };
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph1_fy2[35] = { 8.577024, 7.657039, 8.977688, 7.320869, 6.091666, 4.248953, 2.602726, 1.583493, 0.7523298, 1.542652, 2.971017, 4.227442, 4.753911, 6.488008, 6.78941, 8.222532, 9.452516,
   10.03827, 12.03599, 13.85803, 15.86406, 15.61354, 19.4436, 22.23314, 26.02372, 32.19026, 39.55963, 46.88874, 52.12571, 56.18862, 60.27053, 68.58686, 72.79597,
   74.53732, 74.89893 };
   ...
   Graph_Graph12->SetMinimum(0.6770968);
   Graph_Graph12->SetMaximum(82.31359);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph2_fy3[35] = { 70.13759, 6.918836, 6.682193, 2.975589, 2.749479, 1.89122, 1.398504, 1.116389, 1.182163, 2.369541, 1.314276, 3.592414, 2.064902, 8.66102, 5.155558, 5.694747, 13.74557,
   10.7973, 9.038794, 5.763876, 5.867195, 8.238518, 6.579316, 6.324351, 5.402458, 5.607975, 6.76738, 7.970083, 5.51455, 5.631614, 3.744638, 6.828213, 4.338348,
   5.13559, 4.282439 };
   ...
   Graph_Graph23->SetMinimum(1.00475);
   Graph_Graph23->SetMaximum(77.03971);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph3_fy4[35] = { 1.465297, 1.183593, 2.410245, 0.6157696, 1.596808, 2.155805, 3.359371, 4.355872, 4.309577, 3.629184, 0.822556, 7.386053, 13.88979, 20.69523, 8.298779, 4.450262, 4.195476,
   5.266345, 6.887352, 0.3210068, 5.400383, 6.3371, 7.005942, 10.72146, 12.37741, 20.30258, 21.93909, 27.25278, 30.60883, 20.69002, 28.01458, 40.80446, 44.02239,
   47.86, 44.79628 };
   ...
   Graph_Graph34->SetMinimum(0.2889061);
   Graph_Graph34->SetMaximum(52.6139);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph4_fy5[35] = { 0.03411174, 0.02413988, 0.0146389, 0.008404255, 0.0115633, 0.01239777, 0.009250641, 0.006449223, 0.003516674, 0.005197525, 0.004225969, 0.01040101, 0.006085634, 0.008547306, 0.0120461, 0.01299381, 0.01573563,
   0.02616048, 0.01232624, 0.02055764, 0.007867813, 0.0274837, 0.02660155, 0.04930496, 0.04549623, 0.04566312, 0.04897118, 0.04841685, 0.04506111, 0.03914833, 0.03585815, 0.03318787, 0.03138781,
   0.03385544, 0.03805161 };
   ...
   Graph_Graph45->SetMinimum(0.003165007);
   Graph_Graph45->SetMaximum(0.05388379);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph5_fy6[35] = { 5.846477, 5.797887, 5.726349, 5.782378, 5.506325, 5.18918, 3.776002, 2.120411, 0.8624315, 0.08249879, 2.278626, 3.313524, 3.961998, 7.45129, 6.573057, 7.209915, 10.81405,
   11.10097, 11.59184, 13.61076, 14.49021, 12.48257, 15.25677, 19.4815, 26.30629, 21.35003, 31.05286, 39.02754, 49.58997, 63.99683, 80.53649, 81.79198, 74.3581,
   54.96527, 65.79211 };
   ...
   Graph_Graph56->SetMinimum(0.07424891);
   Graph_Graph56->SetMaximum(89.96292);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph6_fy7[35] = { 2.313358, 2.466601, 2.175337, 1.693988, 1.34964, 0.9765387, 0.6574273, 0.2754033, 0.02356768, 0.3365993, 0.6636977, 0.9845495, 1.227772, 1.632917, 1.67774, 2.168572, 2.611828,
   2.427447, 3.018093, 3.272736, 3.733373, 3.647029, 4.003358, 4.143548, 4.31447, 4.020548, 3.916025, 3.495777, 2.918625, 2.480996, 2.080417, 2.208757, 1.897836,
   1.400602, 0.9807467 };
   ...
   Graph_Graph67->SetMinimum(0.02121091);
   Graph_Graph67->SetMaximum(4.743561);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph7_fy8[35] = { 0.7366657, 0.7125974, 0.70467, 0.6954908, 0.6770015, 0.6167293, 0.457871, 0.2683282, 0.1400471, 0.04458427, 0.2262115, 0.3996611, 0.5024195, 0.8108735, 0.8426666, 1.059973, 1.25891,
   1.33363, 1.574755, 1.714289, 1.93733, 1.99331, 2.303016, 2.451265, 2.599299, 2.67601, 2.83041, 2.843106, 2.699375, 2.586102, 2.53787, 2.754891, 2.826941,
   2.701283, 2.563751 };
   ...
   Graph_Graph78->SetMinimum(0.04012585);
   Graph_Graph78->SetMaximum(3.122958);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph8_fy9[35] = { 71.32544, 12.68784, 13.42693, 10.45084, 9.402659, 7.905667, 6.487604, 5.810313, 5.219591, 5.250397, 4.911675, 10.28063, 15.69557, 24.83053, 14.19577, 13.9614, 21.03504,
   19.96986, 21.15896, 21.14012, 23.92662, 23.40859, 27.34429, 32.79864, 40.01698, 44.50393, 55.69436, 67.5871, 78.598, 87.99483, 104.6193, 114.6383, 113.2033,
   104.51, 109.4122 };
   ...
   Graph_Graph89->SetMinimum(4.420507);
   Graph_Graph89->SetMaximum(125.611);
