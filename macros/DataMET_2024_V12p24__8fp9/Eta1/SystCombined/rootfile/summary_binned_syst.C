...
//=========  (Sat May 30 11:47:25 2026) by ROOT version 6.32.13
   ...
   2500, 3200 };
   Double_t Graph0_fy1[35] = { 3.436654, 2.720937, 2.498506, 2.275644, 2.459938, 3.041806, 3.885987, 4.792224, 5.912735, 7.218438, 8.0429, 8.906558, 9.82422, 10.5802, 10.73505, 10.7048, 10.77992,
   10.47241, 10.59592, 8.502136, 8.460374, 7.426939, 6.816773, 6.375765, 6.152648, 5.463677, 5.397903, 5.240539, 5.293766, 5.359085, 5.238544, 5.974378, 5.151691,
   5.432796, 4.149584e-05 };
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph1_fy2[35] = { 4.335392, 4.155934, 2.797312, 0.1136363, 2.838624, 5.497503, 8.227777, 10.56666, 13.45297, 16.02343, 18.72064, 21.79678, 24.76792, 28.03991, 31.22377, 34.17939, 37.0957,
   38.8185, 41.663, 43.8248, 46.50377, 49.97225, 54.09481, 58.12421, 62.62402, 67.19629, 72.74283, 77.52639, 81.15756, 84.29389, 88.67513, 93.32877, 96.35358,
   94.63995, 95.7663 };
   ...
   Graph_Graph12->SetMinimum(0.1022726);
   Graph_Graph12->SetMaximum(105.9776);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph2_fy3[35] = { 9.912896, 3.955019, 0.09806156, 0.7410228, 0.4175663, 1.133102, 2.025056, 0.5723774, 0.6488919, 0.5487025, 0.5981088, 1.28516, 1.932979, 2.723205, 1.308668, 2.148557, 1.8911,
   0.294137, 3.870559, 1.676071, 1.635599, 2.785611, 2.154768, 5.59206, 2.817369, 3.843892, 3.222281, 3.99828, 5.563742, 4.084879, 6.461716, 3.267944, 8.357215,
   9.651321, 3.558147 };
   ...
   Graph_Graph23->SetMinimum(0.08825541);
   Graph_Graph23->SetMaximum(10.89438);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph3_fy4[35] = { 0.05919933, 0.4907489, 0.4535556, 0.5939424, 0.3027439, 0.709641, 0.8877099, 1.295531, 2.358758, 3.719711, 4.31459, 7.5333, 7.625711, 10.58544, 11.5908, 13.84792, 15.42618,
   14.46172, 19.3112, 19.29667, 19.81975, 21.68781, 25.3707, 25.83627, 29.15038, 29.38477, 34.18079, 38.12846, 39.00772, 36.60522, 37.75677, 45.88913, 50.68685,
   50.42685, 48.2712 };
   ...
   Graph_Graph34->SetMinimum(0.0532794);
   Graph_Graph34->SetMaximum(55.74961);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph4_fy5[35] = { 0.01893044, 0.009304285, 0.005102158, 0.001204014, 0.009047985, 0.01634359, 0.02154112, 0.022614, 0.02678633, 0.03373623, 0.03728867, 0.02858639, 0.02179146, 0.01685619, 0.01400709, 0.01012087, 0.009906292,
   0.006186962, 0.008738041, 0.01348257, 0.01841784, 0.02453327, 0.03055334, 0.03646612, 0.0418663, 0.04717112, 0.05153418, 0.05434752, 0.05573034, 0.05582571, 0.05472898, 0.05279779, 0.05702972,
   0.06583929, 0.07417202 };
   ...
   Graph_Graph45->SetMinimum(0.001083612);
   Graph_Graph45->SetMaximum(0.08146882);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph5_fy6[35] = { 2.935874, 2.753687, 2.174532, 0.2915382, 1.960176, 4.402786, 6.673985, 9.332424, 10.51797, 11.49331, 12.33844, 12.1491, 10.95085, 19.04133, 10.87598, 13.34313, 18.01974,
   19.68755, 22.00358, 24.49731, 28.40483, 31.96805, 41.16633, 48.65281, 58.11655, 46.39278, 49.16032, 54.02721, 66.01521, 87.18891, 97.08082, 99.72914, 100,
   100, 100 };
   ...
   Graph_Graph56->SetMinimum(0.2623844);
   Graph_Graph56->SetMaximum(109.9708);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph6_fy7[35] = { 1.010525, 0.3665566, 0.2108574, 0.3506184, 0.3397346, 0.2525926, 0.05576611, 0.1465678, 0.3216624, 0.5867124, 0.7268369, 0.9162545, 1.250035, 1.552743, 1.627284, 1.662004, 1.635611,
   1.55825, 1.522487, 1.422495, 1.315451, 1.272953, 1.214427, 1.132697, 1.044005, 0.9859681, 0.9420872, 0.8822978, 0.8197784, 0.7617712, 0.7961988, 0.7677317, 0.848335,
   0.8191764, 0.7624865 };
   ...
   Graph_Graph67->SetMinimum(0.0501895);
   Graph_Graph67->SetMaximum(1.822628);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph7_fy8[35] = { 0.2866387, 0.2824903, 0.2237916, 0.03171563, 0.1786232, 0.4039288, 0.6500363, 0.8860826, 1.153255, 1.43317, 1.624322, 1.802862, 1.961684, 2.09235, 2.142966, 2.1577, 2.173078,
   2.093399, 2.106237, 2.006674, 1.949763, 1.882195, 1.832104, 1.736784, 1.684928, 1.590848, 1.539826, 1.477158, 1.371503, 1.280296, 1.261449, 1.340473, 1.350677,
   1.164174, 1.092541 };
   ...
   Graph_Graph78->SetMinimum(0.02854407);
   Graph_Graph78->SetMaximum(2.387214);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph8_fy9[35] = { 11.77278, 6.9538, 4.371038, 2.510436, 4.285417, 7.802204, 11.51756, 14.98423, 18.27538, 21.389, 24.28022, 27.64995, 29.95306, 37.24253, 36.76618, 40.80027, 45.45272,
   47.11885, 52.21968, 54.53658, 58.66892, 63.69949, 72.94198, 80.55591, 90.54706, 87.05876, 94.44238, 102.1248, 111.9272, 126.8658, 137.0582, 144.2593, 148.1624,
   147.052, 146.6824 };
   ...
   Graph_Graph89->SetMinimum(2.259392);
   Graph_Graph89->SetMaximum(162.7276);
