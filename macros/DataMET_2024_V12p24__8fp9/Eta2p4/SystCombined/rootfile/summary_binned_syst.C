...
//=========  (Sat May 30 11:46:54 2026) by ROOT version 6.32.13
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph1_fy2[35] = { 4.980588, 4.948312, 3.936267, 2.496028, 1.632774, 0.9687185, 1.665449, 2.239931, 2.805245, 3.358996, 4.729062, 5.881953, 6.479478, 8.412128, 8.57448, 9.965449, 11.48258,
   11.90114, 12.98144, 14.42564, 15.46043, 15.68062, 19.35269, 21.76008, 26.1871, 32.65476, 40.09716, 47.25804, 52.08899, 55.95927, 60.22438, 67.63357, 71.64662,
   73.19605, 73.18226 };
   ...
   Graph_Graph12->SetMinimum(0.8718467);
   Graph_Graph12->SetMaximum(80.41879);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph2_fy3[35] = { 12.05211, 3.345692, 1.260138, 1.514751, 1.465845, 0.8793294, 1.467901, 0.577724, 1.639831, 2.515692, 1.806623, 3.983963, 1.517999, 8.49278, 6.017077, 5.74162, 11.2151,
   11.96159, 8.176029, 3.233123, 5.546498, 10.14957, 5.448163, 4.738212, 3.891265, 4.734123, 6.860554, 8.529436, 6.578398, 7.262051, 5.882192, 9.317648, 7.295108,
   6.050384, 8.590364 };
   ...
   Graph_Graph23->SetMinimum(0.5199516);
   Graph_Graph23->SetMaximum(13.19955);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph3_fy4[35] = { 0.3631473, 0.2753854, 0.6141961, 0.702244, 0.6914973, 1.561427, 2.499878, 3.371978, 3.366256, 2.940607, 0.9048462, 7.225144, 12.60809, 20.07638, 7.173681, 5.009556, 4.981136,
   4.266768, 7.330394, 1.601386, 5.915809, 5.19377, 8.043802, 11.58328, 13.37916, 21.2999, 23.14349, 28.78111, 32.57078, 22.97854, 30.74747, 43.52474, 47.18026,
   52.12612, 49.20596 };
   ...
   Graph_Graph34->SetMinimum(0.2478468);
   Graph_Graph34->SetMaximum(57.3112);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph4_fy5[35] = { 0.0287652, 0.02356768, 0.02067089, 0.01745224, 0.01219511, 0.008094311, 0.006830692, 0.01814365, 0.02565384, 0.03216863, 0.04003644, 0.04729033, 0.04979372, 0.0597775, 0.05664825, 0.05916357, 0.06323457,
   0.06989837, 0.05402565, 0.06332397, 0.06186962, 0.07292032, 0.06516576, 0.08553267, 0.09189844, 0.09126067, 0.08881092, 0.08718371, 0.08445978, 0.08171201, 0.07928014, 0.07371306, 0.07234216,
   ...
   Graph_Graph45->SetMinimum(0.006147623);
   Graph_Graph45->SetMaximum(0.1004052);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph7_fy8[35] = { 0.4843116, 0.4884243, 0.4276633, 0.2991915, 0.2164721, 0.1484156, 0.02781749, 0.1520455, 0.2586842, 0.4137278, 0.5829394, 0.7552147, 0.8573294, 1.168001, 1.204836, 1.41753, 1.626611,
   1.708722, 1.973975, 2.125168, 2.342546, 2.395701, 2.704823, 2.884591, 3.019035, 3.082275, 3.143573, 3.04116, 2.779961, 2.53886, 2.355337, 2.465761, 2.396667,
   2.120912, 1.860678 };
   ...
   Graph_Graph78->SetMinimum(0.02503574);
   Graph_Graph78->SetMaximum(3.455148);
   ...
   340, 360, 380, 410, 440, 480, 530, 590, 660, 760, 880, 1030, 1210, 1440, 1730, 2000,
   2500, 3200 };
   Double_t Graph8_fy9[35] = { 14.26351, 7.790147, 6.034579, 4.407549, 3.406818, 3.01341, 3.929459, 4.857327, 5.664211, 6.451822, 7.709412, 12.19365, 16.07669, 25.9345, 16.30808, 16.92496, 22.51721,
   23.28505, 23.75691, 23.51653, 26.21764, 26.08319, 29.78294, 35.27139, 43.06957, 47.23881, 58.58559, 70.13127, 80.66366, 89.43079, 106.0435, 116.302, 115.9782,
   108.8233, 112.6856 };
   ...
   Graph_Graph89->SetMinimum(2.712069);
   Graph_Graph89->SetMaximum(127.6308);
