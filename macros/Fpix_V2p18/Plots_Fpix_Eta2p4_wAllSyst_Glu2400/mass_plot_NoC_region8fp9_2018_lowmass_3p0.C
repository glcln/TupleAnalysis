void mass_plot_NoC_region8fp9_2018_lowmass_3p0()
{
//=========Macro generated from canvas: c1/c1
//=========  (Mon Apr 28 14:20:43 2025) by ROOT version 6.14/09
...
// ------------>Primitives in pad: t3
   ...
   TH1D *frameR2__8 = new TH1D("frameR2__8","",1,0,300);
   frameR2__8->SetMinimum(0);
   frameR2__8->SetMaximum(2);
   frameR2__8->SetStats(0);
   frameR2__8->SetLineStyle(0);
   frameR2__8->SetMarkerStyle(20);
   frameR2__8->GetXaxis()->SetNdivisions(505);
   frameR2__8->GetXaxis()->SetLabelFont(43);
   frameR2__8->GetXaxis()->SetLabelOffset(0.007);
   frameR2__8->GetXaxis()->SetLabelSize(20);
   frameR2__8->GetXaxis()->SetTitleSize(20);
   frameR2__8->GetXaxis()->SetTitleOffset(3.75);
   frameR2__8->GetXaxis()->SetTitleFont(43);
   frameR2__8->GetYaxis()->SetTitle("obs / pred");
   frameR2__8->GetYaxis()->SetNdivisions(503);
   frameR2__8->GetYaxis()->SetLabelFont(43);
   frameR2__8->GetYaxis()->SetLabelOffset(0.007);
   frameR2__8->GetYaxis()->SetLabelSize(12);
   frameR2__8->GetYaxis()->SetTitleSize(14);
   frameR2__8->GetYaxis()->SetTitleOffset(1.25);
   frameR2__8->GetYaxis()->SetTitleFont(43);
   frameR2__8->GetZaxis()->SetLabelFont(42);
   frameR2__8->GetZaxis()->SetLabelOffset(0.007);
   frameR2__8->GetZaxis()->SetLabelSize(0.05);
   frameR2__8->GetZaxis()->SetTitleSize(0.06);
   ...
   TH1F *obs_new__9 = new TH1F("obs_new__9","",35, xAxis7);
   obs_new__9->SetBinContent(1,1.040194);
   obs_new__9->SetBinContent(2,0.9761538);
   obs_new__9->SetBinContent(3,0.995943);
   obs_new__9->SetBinContent(4,1.009648);
   obs_new__9->SetBinContent(5,0.9874854);
   obs_new__9->SetBinContent(6,1.011704);
   obs_new__9->SetBinContent(7,1.015868);
   obs_new__9->SetBinContent(8,0.9946514);
   obs_new__9->SetBinContent(9,1.028072);
   obs_new__9->SetBinContent(10,0.9945254);
   obs_new__9->SetBinContent(11,1.008052);
   obs_new__9->SetBinContent(12,1.005748);
   obs_new__9->SetBinContent(13,1.006205);
   obs_new__9->SetBinContent(14,1.018518);
   obs_new__9->SetBinContent(15,1.035529);
   obs_new__9->SetBinContent(16,1.031108);
   obs_new__9->SetBinError(1,0.07108879);
   obs_new__9->SetBinError(2,0.01421217);
   obs_new__9->SetBinError(3,0.04409682);
   obs_new__9->SetBinError(4,0.01635095);
   obs_new__9->SetBinError(5,0.02678203);
   obs_new__9->SetBinError(6,0.03072379);
   obs_new__9->SetBinError(7,0.02242454);
   obs_new__9->SetBinError(8,0.04501682);
   obs_new__9->SetBinError(9,0.08414012);
   obs_new__9->SetBinError(10,0.03646614);
   obs_new__9->SetBinError(11,0.04441024);
   obs_new__9->SetBinError(12,0.03961978);
   obs_new__9->SetBinError(13,0.0373262);
   obs_new__9->SetBinError(14,0.1339154);
   obs_new__9->SetBinError(15,0.08424151);
   obs_new__9->SetBinError(16,0.08005187);
   obs_new__9->SetEntries(4626.543);
   ...
   pol11->SetParent(obs_new__9);
   obs_new__9->GetListOfFunctions()->Add(pol11);
   obs_new__9->SetMarkerStyle(21);
   obs_new__9->SetMarkerSize(0.7);
   obs_new__9->GetXaxis()->SetTitle("Mass [GeV]");
   obs_new__9->GetXaxis()->SetRange(1,15);
   obs_new__9->GetXaxis()->SetLabelFont(42);
   obs_new__9->GetXaxis()->SetLabelSize(0.035);
   obs_new__9->GetXaxis()->SetTitleSize(0.035);
   obs_new__9->GetXaxis()->SetTitleFont(42);
   obs_new__9->GetYaxis()->SetLabelFont(42);
   obs_new__9->GetYaxis()->SetLabelSize(0.035);
   obs_new__9->GetYaxis()->SetTitleSize(0.035);
   obs_new__9->GetYaxis()->SetTitleOffset(0);
   obs_new__9->GetYaxis()->SetTitleFont(42);
   obs_new__9->GetZaxis()->SetLabelFont(42);
   obs_new__9->GetZaxis()->SetLabelSize(0.035);
   obs_new__9->GetZaxis()->SetTitleSize(0.035);
...
// ------------>Primitives in pad: t4
   ...
   TH1D *frameR3__10 = new TH1D("frameR3__10","",1,0,300);
   frameR3__10->SetMinimum(-3);
   frameR3__10->SetMaximum(3);
   frameR3__10->SetStats(0);
   frameR3__10->SetLineStyle(0);
   frameR3__10->SetMarkerStyle(20);
   frameR3__10->GetXaxis()->SetTitle("Mass (GeV)");
   frameR3__10->GetXaxis()->SetLabelFont(43);
   frameR3__10->GetXaxis()->SetLabelOffset(0.007);
   frameR3__10->GetXaxis()->SetLabelSize(14);
   frameR3__10->GetXaxis()->SetTitleSize(20);
   frameR3__10->GetXaxis()->SetTitleOffset(3.75);
   ...
   frameR3__10->GetYaxis()->SetLabelOffset(0.007);
   frameR3__10->GetYaxis()->SetLabelSize(12);
   frameR3__10->GetYaxis()->SetTitleSize(16);
   frameR3__10->GetYaxis()->SetTickLength(0.06);
   frameR3__10->GetYaxis()->SetTitleOffset(1.25);
   frameR3__10->GetYaxis()->SetTitleFont(43);
   frameR3__10->GetZaxis()->SetLabelFont(42);
   frameR3__10->GetZaxis()->SetLabelOffset(0.007);
   frameR3__10->GetZaxis()->SetLabelSize(0.05);
   frameR3__10->GetZaxis()->SetTitleSize(0.06);
   ...
   TH1F *pred_new__11 = new TH1F("pred_new__11","",35, xAxis8);
   pred_new__11->SetBinContent(1,0.5881138);
   pred_new__11->SetBinContent(2,-1.638167);
   pred_new__11->SetBinContent(3,-0.0916291);
   pred_new__11->SetBinContent(4,0.5956873);
   pred_new__11->SetBinContent(5,-0.4614698);
   pred_new__11->SetBinContent(6,0.3853712);
   pred_new__11->SetBinContent(7,0.7186118);
   pred_new__11->SetBinContent(8,-0.1181823);
   pred_new__11->SetBinContent(9,0.3429597);
   pred_new__11->SetBinContent(10,-0.1493276);
   pred_new__11->SetBinContent(11,0.1827374);
   pred_new__11->SetBinContent(12,0.1458789);
   pred_new__11->SetBinContent(13,0.1671918);
   pred_new__11->SetBinContent(14,0.1408206);
   pred_new__11->SetBinContent(15,0.4361901);
   pred_new__11->SetBinContent(16,0.4000134);
   pred_new__11->SetBinError(1,8384.565);
   pred_new__11->SetBinError(2,4483.47);
   pred_new__11->SetBinError(3,9417.678);
   pred_new__11->SetBinError(4,2166.083);
   pred_new__11->SetBinError(5,2616.793);
   pred_new__11->SetBinError(6,1974.568);
   pred_new__11->SetBinError(7,974.6339);
   pred_new__11->SetBinError(8,1408.656);
   pred_new__11->SetBinError(9,1665.177);
   pred_new__11->SetBinError(10,497.5426);
   pred_new__11->SetBinError(11,395.5488);
   pred_new__11->SetBinError(12,237.2902);
   pred_new__11->SetBinError(13,143.8477);
   pred_new__11->SetBinError(14,381.3236);
   pred_new__11->SetBinError(15,160.4235);
   pred_new__11->SetBinError(16,108.7754);
   pred_new__11->SetBinError(17,1095.184);
   pred_new__11->SetBinError(18,746.0742);
   pred_new__11->SetBinError(19,602.7457);
   pred_new__11->SetBinError(20,603.0703);
   pred_new__11->SetBinError(21,430.7242);
   pred_new__11->SetBinError(22,340.254);
   pred_new__11->SetBinError(23,278.2657);
   pred_new__11->SetBinError(24,163.0563);
   pred_new__11->SetBinError(25,106.078);
   pred_new__11->SetBinError(26,71.20052);
   pred_new__11->SetBinError(27,36.06265);
   pred_new__11->SetBinError(28,17.38978);
   pred_new__11->SetBinError(29,8.246458);
   pred_new__11->SetBinError(30,3.970643);
   pred_new__11->SetBinError(31,1.635199);
   pred_new__11->SetBinError(32,0.575956);
   pred_new__11->SetBinError(33,0.3747009);
   pred_new__11->SetBinError(34,0.1446313);
   pred_new__11->SetBinError(35,0.0559234);
